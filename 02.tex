...
\emph{Heleno Araújo}\footnote{Professor da Educação Básica. Presidente da
  ...
  Pernambuco (\versal{SINTEPE}). Coordenador do Fórum Nacional Popular de
  Educação (\versal{FNPE}). heleno@cnte.org.br.}
\end{flushright}
...
na Constituição Federal de 1988 o capítulo dedicado à educação\footnote{\textbf{Constituição
  ...
  Desporto, Seção I
  - da educação, artigos 205 a0 214.}. A \versal{IV} Conferência Brasileira de
...
dos candidatos às Constituintes em nível federal e estadual (\versal{CARTA DE
GOIÂNIA}, 1986).
...
67)\footnote{\versal{PINHEIRO}, Camila Mendes. O Fórum Nacional em
...
\versal{PROFUNCIONÁRIO}\footnote{Foram oferecidos cursos técnicos pós"-médio em
...
no governo Lula com a aprovação da Lei do \versal{FUNDEB}\footnote{\textbf{Lei n.
...
Lei n.11.738 de 2008\footnote{Lei n - 11.738, de 16 de
  julho de 2008, Regulamenta a alínea "e" do inciso \versal{III} do caput do art.
...
Educação\footnote{\textbf{Lei n. 13.005, de 25 de junho de 2014}, Aprova
  o Plano Nacional de Educação - \versal{PNE} e dá outras providências.}, sendo o
...
(\versal{PSDB}"-45). Obrigou a ser vinculado percentual do \versal{PIB} para investimentos
...
o novo \versal{PNE} 2014-2024, mesmo tendo o seu governo enviado ao Congresso
Nacional, a proposta de vincular 7\% \versal{PIB} para próxima década, o
...
criação no âmbito do \versal{MEC}, com atribuições de participar processo de
...
A aliança golpista do \versal{PMDB} (15) e o \versal{PSDB} (45), infelizmente com o apoio
e votos do \versal{PSB} (40)\footnote{Um dos objetivos do \textbf{Partido
  Socialista Brasileiro} (\versal{PSB}, 40) é estimular o desenvolvimento de
...
Orçamentária (\versal{LDO}) em todos os itens que indicavam aplicação de recursos
para garantir a implementação do \versal{PNE} é inaceitável e temos que reagir
...
retirada dos direitos trabalhistas\footnote{\textbf{Lei n. 13.467, de 13
  de julho de 2017}. Altera a Consolidação das Leis do Trabalho (\versal{CLT}),
...
as deliberações do pleno do \versal{FNE}, e com a Portaria do \versal{MEC} n. 577, de 27
