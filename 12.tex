...
fundamentais.\footnote{Sobre a mobilização dos movimentos sociais em
  ...
  sociais novos?'' \emph{Caderno \versal{CEAC}/\versal{U}n\versal{B}}, Ano 1, \versal{N}º 1, 1987. p.9-16.
  {[}Constituinte: temas em análise{]}; \versal{SOUSA} \versal{JUNIOR}, José Geraldo de.
  ``Triste do Poder que não pode''. \emph{Caderno \versal{CEAC}/\versal{U}n\versal{B}}, Ano 1, \versal{N}º 1, 1987. p.25-31. {[}Constituinte: temas em análise{]}; \versal{COELHO}, João
  Gilberto Lucas. ``A Garantia das Instituições''. \emph{Caderno
  \versal{CEAC}/\versal{U}n\versal{B}}, Ano 1, \versal{N}º 1, 1987. p.37-45. {[}Constituinte: temas em
  ...
  \versal{U}n\versal{B}, 2015. p.51-54. (Livro todo disponível em
...
Em seu livro \emph{Ditadura e repressão}, no qual promove um estudo
...
não sendo mesmo anistiados pela Lei \versal{N}º 6.683/1979.\footnote{Acrescente"-se
  ...
  anota Heloísa Grecco em sua tese (\versal{GRECO}, \emph{op. cit.}), e também \versal{RODEGHERO}
...
do Art.85 da \versal{C.F.} de 1988 afirma que são crimes de responsabilidade atos
