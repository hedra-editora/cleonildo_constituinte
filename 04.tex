...
\hedramarkboth{A fotografia constitucional de 1988}{}
...
Constituições.\footnote{\versal{LASSALLE}, F. \emph{O que é uma Constituição?} (Tradução de
  Ricardo Rodrigues Gama). Campinas: Russell Editores, 1a. ed. \emph{eBook},
...
efetivos de poder.\footnote{\emph{Op. cit.}, posição 753 (\emph{eBook}).}
\end{quote}
...
enfermidade'' e a declaração da vacância do seu cargo,\footnote{A
  ...
  Institucional ficavam ``excluídos de apreciação judicial'' (art. 8º).
...
\subsection{Constituição de 1988: a fotografia de um~Estado~Democrático~de~Direito}
...
coletivos,\footnote{Estão concentrados no art. 5º da \versal{C.F.}, mas podem ser
...
\section{A Constituição de 1988 e o seu efeito~``transformador''}
...
virtude de lei}, de outro, às vezes, o Estado necessita agir de imediato
...
nome.\footnote{\emph{A Marcha da Insensatez -- de Troia ao Vietnã.} São
  Paulo: José Olympio Editora, 4ª. ed., 1985.} Não seria diferente no
...
Por isso, dado o impeachment de Dilma Rousseff, o que era
