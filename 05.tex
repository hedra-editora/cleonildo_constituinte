...
\hedramarkboth{Morreu na contramão atrapalhando o sábado}{}

\begin{flushright}
\emph{Maria Goretti Nagime Barros Costa}\footnote{Advogada, mestra em
...
Direito no Conselho Latino-americano de Ciências Sociais (\versal{CLACSO}).}
\end{flushright}
...
demissão arbitrária dirigentes sindicais e membros de \versal{CIPA}s (Comissões
...
A responsável pela mágica de investir"-se pouco e lucrar"-se muito é a
...
estado de produtos'"\footnote{\versal{CASARA}, Rubens. Apresentação. In:
  \versal{TAVARES}, Juarez; \versal{PRADO}, Geraldo. \emph{O Direito Penal e o Processo
  Penal no Estado de Direito: análise de casos}. Florianópolis: Empório
  do Direito, 2016.}. Os direitos
...
desenvolvimento do mercado {[}\ldots{}{]}''\footnote{\versal{TAVARES}, Juarez; \versal{PRADO},
  Geraldo. \emph{O Direito Penal e o Processo Penal no Estado de
...
liberdades democráticas, inegavelmente constituiu um marco histórico do
...
tenta tirar o candidato popular da disputa através de \emph{Lawfare}. Tenta até
...
\noindent{}eliminação do trabalho escravo infantil na região do Nordeste, o que

\noindent{}provocou a ira da classe que era beneficiada com a
escravidão.''\footnote{\versal{NAGIME}, Maria Goretti. Quem está acima da lei?
  In: \emph{Comentários a uma sentença anunciada:} o processo Lula.
  Bauru: Projeto Editorial Praxis, 2017, p. 366.}

Sobre a Reforma Trabalhista, é inegável a incidência em gravíssimo
...
trabalhadores e empresários pode ser ilustrada pelo próprio \versal{PL}. O
...
pagar o parlamentar para alterar uma lei em seu favor.\footnote{\versal{CALLEGARI},
  ...
  em: \textless{}\emph{https://bit.ly/2GPNzDV}\textgreater{}.
...
Há uma correlação lógica inegável entre os três acontecimentos:

\begin{enumerate}
\item
O golpe de Estado que retira da presidência um governo popular eleito
através de voto; 
\item
um líder historicamente reconhecido por projetos
...
Os três acontecimentos são nítidas demonstrações da fragilidade do Estado Democrático de Direito.
