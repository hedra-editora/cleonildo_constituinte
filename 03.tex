...
\textbf{``} O \versal{PMDB} sabe que a crise nacional não encontrara solução sem
...
vergonha nacional. Compromisso fundamental do \versal{PMDB} e a extinção do
...
Quer e sabe como fazê"-lo. O \versal{PMDB} tem planos e propostas serias,
possíveis, viáveis. Propostas que certamente exigem determinação,
imaginação, competência. O \versal{PMDB} as tem! Propostas em aberto que sao
