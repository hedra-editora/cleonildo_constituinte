...
\addcontentsline{toc}{chapter}{Desdobramentos hermenêutico"-constitucionais do
impeachment\\ da ex"-presidente Dilma Rousseff no contexto da
``pós"-democracia'',\\ \scriptsize{por Bruno Galindo}}
\hedramarkboth{Desdobramentos hermenêutico"-constitucionais\ldots{}}{}

\begin{flushright}
\emph{Bruno Galindo}\footnote{Professor Associado da Faculdade de Direito do Recife/Universidade
Federal de Pernambuco (\versal{UFPE}), é
Doutor em Direito pela \versal{UFPE}/Universidade de Coimbra"-Portugal
(\versal{PDEE}) e Conselheiro Estadual da \versal{OAB}/\versal{PE}.}
\end{flushright}
...
uma ``pausa democrática'' (nos dizeres do Ministro aposentado do \versal{STF}
...
Tendo como pano de fundo o recente processo de impeachment que
...
Antes do processo de impeachment da Presidente Dilma Roussef, a
...
poder'', tal como já denunciara Ferdinand Lassalle no século \versal{XIX}, ou o
...
Nesse contexto, destaquei em meu estudo que o impeachment se
...
Congresso Nacional, em aparente violação à \versal{C.F.}, art. 85, \versal{V} a \versal{VII}, e à Lei
1079/1950, arts. 4º, \versal{V} e \versal{VI}; 9º, 3 e 7; 10, 6 a 9; e 11, 3.
...
1079/1950 (o seu ``\versal{DNA} parlamentarista'', em particular\footnote{Cf. Queiroz:
...
trabalhos do \versal{TCU} antes de se emitir uma opinião sobre a configuração
...
tipificados no art. 359-\versal{A} do Código Penal, de modo bastante assemelhado
...
mudança paradigmática da jurisprudência do \versal{TCU}\footnote{Disponível em: \textless{}\emph{https://bit.ly/2RzetSc}\textgreater{}, acesso em 21/12/2015.}.
...
solução para os casos futuros, como um alerta de que o \versal{TCU} não mais
...
inconstitucionalidade da lei descumprida\footnote{Tal situação
  ...
  que chegou a ser julgado nos \versal{EUA}, em que o então Presidente Andrew
...
regulamentar (\versal{C.F.}, art. 49, \versal{V}). Em tais situações, é claro que o
...
único, da \versal{C.F.} Em ambos os casos, os Relatores, Mins. Teori Zavascki e
...
uma já esperada posição política de autocontenção do \versal{STF}\footnote{Sobre
...
sediados nos incisos do art. 85 da \versal{C.F.} São estes os bens jurídicos
...
notadamente os relacionados à liberdade de ir e vir\footnote{\versal{STF}, \versal{MS} 34371"-\versal{MC},
Rel. Min. Teori Zavascki, \versal{DJ}e 12/09/2016.}.
\end{quote}
...
aqueles elencados no art. 85 da \versal{C.F.} e não podem ser solenemente ignorados
...
E o \versal{STF}, tal como ocorre com os tribunais de democracias não
...
Em minha modesta percepção, o \versal{STF} permitiu, conscientemente ou não, a
...
\begin{Parskip}
\versal{ACKERMAN}, Bruce. \emph{We the people 2 -- transformations}.
Cambridge/ Massachusets: Belknap Press of Harvard University Press, 2001.

\versal{ANASTASIA}, Antonio. Relatório Final no Processo de impeachment da
Presidente Dilma Roussef, 2016.

\versal{ARAÚJO}, Marcelo Labanca; \versal{SANTOS}, Gustavo Ferreira \& \versal{TEIXEIRA}, João
Paulo Allain. \emph{Sobre o impeachment}. In: \textless{}\emph{https://bit.ly/2pDhQMp}\textgreater{},
(acesso: 16/12/2015), 2015.

\versal{BAHIA}, Alexandre Gustavo Melo Franco de Moraes; \versal{SILVA}, Diogo Bacha e \&
\versal{OLIVEIRA}, Marcelo Andrade Cattoni de. \emph{O impeachment e o Supremo
Tribunal Federal: história e teoria constitucional brasileira}.
Florianópolis: Empório do Direito, 2016.

\versal{BALBUENA PÉREZ}, David-Eleuterio. El juicio político en la Constitución
paraguaya y la destitución del Presidente Fernando Lugo. In:
\emph{Revista de Derecho Político}. Madrid: \versal{UNED}, nº 87, pp. 355-398,
2013.

\versal{BICUDO}, Hélio Pereira; \versal{REALE JR}., Miguel \& \versal{PASCHOAL}, Janaína Conceição.
Denúncia contra a Presidente da República Dilma Vana Roussef, 2015.

\versal{BROSSARD}, Paulo. \emph{O impeachment}. 3ª ed. São Paulo: Saraiva, 1992.

\versal{CANOTILHO}, José Joaquim Gomes. \emph{Direito Constitucional e Teoria da
Constituição}. 6ª ed. Coimbra: Almedina, 2002.

\versal{DARDOT}, Pierre \& \versal{LAVAL}, Christian. \emph{A nova razão do mundo -- ensaio
sobre a sociedade neoliberal} (trad. Mariana Echalar). São Paulo:
Boitempo, 2016.

\versal{FERRAZ}, Anna Candida da Cunha. \emph{Processos informais de mudança da
Constituição}. São Paulo: Max Limonad, 1986.

\versal{FERRAZ JR}., Tércio Sampaio. \emph{Introdução ao Estudo do Direito -- Técnica,
Decisão, Dominação}. 4ª ed. São Paulo: Atlas, 2003.

\versal{GALINDO}, Bruno. \emph{Impeachment à luz do constitucionalismo
contemporâneo}. Curitiba: Juruá, 2016.

\versal{GALINDO}, Bruno. Constitucionalismo e justiça de transição: em busca de
...
de Minas Gerais}. Belo Horizonte: \versal{UFMG}, nº 67, pp. 75-104, 2015.

\versal{GALINDO}, Bruno. \emph{Direitos fundamentais (análise de sua concretização
constitucional)}. Curitiba: Juruá, 2003.

\versal{GUEDES}, Jefferson Gadús \& \versal{PÁDUA}, Thiago Aguiar de. Pedaladas
jurisprudenciais do \versal{TCU} ou prospective overruling? In:
\textless{}\emph{https://bit.ly/2Oa0she}\textgreater{},
(acesso: 11/12/2015).

\versal{HOLMES}, Pablo. Por que foi um golpe. In:
\textless{}\emph{https://bit.ly/2z\\TCrC3}\textgreater{},
(acesso: 04/09/2016), 2016a.

\versal{HOMERO}. \emph{Odisseia} (trad. Manuel Odorico Mendes). Digitalização da 3ª
edição: eBooksBrasil, 2009.

\versal{LASSALLE}, Ferdinand. \emph{A essência da constituição} (trad. Walter Stönner).
4ª ed. Rio de Janeiro: Lumen Juris, 1998.

\versal{LEZCANO CLAUDE}, Luis. Sobre el ``juicio político'' al Pdte. Fernando
Lugo Méndez. In:
\textless{}\emph{https://bit.ly/2S3zr0V}\textgreater{},
(acesso: 04/09/2016), 2012.

\versal{LIMA}, Flávia Santiago. \emph{Jurisdição constitucional e política (ativismo e
autocontenção no \versal{STF})}. Curitiba: Juruá, 2014.

\versal{LOEWENSTEIN}, Karl. \emph{Teoría de la Constitución} (trad. Alfredo Gallego
Anabitarte). Barcelona: Ariel, 1964.

\versal{MARTINEZ}, Rafael. El juicio político en América
Latina: un golpe de estado encubierto. In:
\textless{}\emph{https://bit.ly/2UxTQa\\X}\textgreater{},
(acesso: 22/12/2015),
2013.

\versal{MARTINS}, Ives Gandra da Silva. Responsabilidade dos agentes públicos por
atos de lesão à sociedade -- inteligência dos §§ 5º e 6º do artigo 37 da
\versal{C.F.} -- improbidade administrativa por culpa ou dolo -- disciplina
jurídica do `impeachment' presidencial (artigo 85 inciso \versal{V} da \versal{C.F.}) --
Parecer, 2015.

\versal{MÜLLER}, Friedrich. \emph{Métodos de trabalho do direito constitucional} (trad.
Peter Naumann). 2ª ed. São Paulo: Max Limonad, 2000.

\versal{NEVES}, Marcelo. Parecer sobre impeachment, 2015.

\versal{NEVES}, Marcelo. \emph{A constitucionalização simbólica}. 2ª ed. São Paulo: \versal{WMF}
Martins Fontes, 2007.

\versal{PÉREZ-LIÑAN}, Aníbal. \emph{Presidential impeachment and the new political
instability in Latin America}. Cambridge: University Press, 2007.

\versal{PRADO}, Geraldo \& \versal{TAVARES}, Juarez. Parecer sobre impeachment,
2015.

\versal{PRONER}, Carol. Golpe branco no Brasil: Dilma alerta na \versal{ONU}. In: \emph\emph (orgs.: \versal{PRONER}, Carol; \versal{CITTADINO}, Gisele;
\versal{TENENBAUM}, Márcio \& \versal{RAMOS FILHO}, Wilson). Bauru: Canal 6, pp. 69-73,
2016.

\versal{QUEIROZ}, Rafael Mafei Rabelo. Impeachment e Lei de Crimes de
Responsabilidade: o cavalo de Troia parlamentarista. In:
\textless{}\emph{https://bit.ly/2S114Yi}\textgreater{},
(acesso: 17/12/2015), 2015.

\versal{RIBEIRO}, Ricardo Lodi. Pedaladas hermenêuticas no pedido de impeachment
de Dilma Roussef. In:
\textless{}\emph{https://bit.ly\\/2RxNZAL}\textgreater{},
(acesso: 11/12/2015), 2015a.

\versal{RIBEIRO}, Ricardo Lodi. Parecer sobre o Pedido de impeachment da
Presidente Dilma Roussef, 2015b.

\versal{SANTOS}, Gustavo Ferreira. Processo de impeachment é político? In:
\textless{}\emph{https://bit.ly/2WzmQ41}\textgreater{},
(acesso: 20/12/2015), 2015.

\versal{SARLET}, Ingo Wolfgang. \emph{A eficácia dos direitos fundamentais}. 6ª ed.
Porto Alegre: Livraria do Advogado, 2006.

\versal{SOUZA}, Marcelo Alves Dias de. \emph{Do precedente judicial à súmula
vinculante}. Curitiba: Juruá, 2006.

\versal{STRECK}, Lenio Luiz. A questão de teorias jurídicas meramente descritivas
ou de como o positivismo jurídico influencia na crise política
brasileira. In: \emph{A resistência ao Golpe de 2016} (orgs.: \versal{PRONER}, Carol;
\versal{CITTADINO}, Gisele; \versal{TENENBAUM}, Márcio \& \versal{RAMOS FILHO}, Wilson). Bauru:
Canal 6, pp. 221-228, 2016.

\versal{TRIBE}, Laurence. \emph{American constitutional law}. 3ª ed. New York: New York
Foundation Press, vol. \versal{I}, 2000.
\end{Parskip}

\subsection{Sites consultados}
