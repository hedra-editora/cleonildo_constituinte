...
Congresso Nacional, em aparente violação à \versal{CF}, art. 85, \versal{V} a \versal{VII}, e à Lei
...
regulamentar (\versal{CF}, art. 49, \versal{V}). Em tais situações, é claro que o
...
único, da \versal{CF}. Em ambos os casos, os Relatores, Mins. Teori Zavascki e
...
sediados nos incisos do art. 85 da \versal{CF}. São estes os bens jurídicos
...
aqueles elencados no art. 85 da \versal{CF} e não podem ser solenemente ignorados
...
\versal{CF} -- improbidade administrativa por culpa ou dolo -- disciplina
jurídica do `impeachment' presidencial (artigo 85 inciso \versal{V} da \versal{CF}) --
Parecer, 2015.
