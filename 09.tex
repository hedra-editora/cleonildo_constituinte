...
Legislador.\footnote{\versal{SANTOS}, Gustavo Ferreira. \emph{Neoconstitucionalismo,
...
\section{Análise de algumas decisões judiciais~proferidas no~âmbito da~Operação Lava"-Jato}
...
literal do dispositivo em consonância com o art. 5º, \versal{LVII} da \versal{C.F.} de 1988,
...
\begin{Parskip}
\versal{BARROSO}, Luís Roberto. \emph{Constituição, democracia e
...
\versal{CALAMANDREI}, Piero. \emph{Eles, os juízes, vistos por um advogado}.
São Paulo, \versal{SP}: Martins Fontes, 1995.

\versal{GHIRARDI}, André Garcez. \emph{Petrobras: as causas da crise, além da
Lava Jato}. Disponível em:
\emph{\textless{}https://bit.ly/2y 9y4lj\textgreater{}}.
Acesso em outubro de 2016.

\versal{JORG}, Janes e \versal{CARVALHO}, Marcelo S. de. \emph{Os trabalhadores diante da
operação Lava Jato}. Disponível em:
\emph{\textless{}https://bit.ly/2TAl7K0\textgreater{}}.
Acesso em 11 de março de 2015.

\versal{LIMA}, Flávia Danielle Santiago. \emph{Ativismo e autocontenção no
...
\versal{NETTO}, Vladimir. \emph{Lava Jato: O juiz Sérgio Moro e os
bastidores da operação que abalou o Brasil}. Rio de Janeiro:
Primeira Pessoa, 2016.

\versal{SCARPINO}, Luiz. \emph{Sérgio Moro: O homem, o juiz e o
Brasil}. Ribeirão Preto: Novo Conceito, 2016.

\versal{SOUZA}, Jessé. \emph{A radiografia do golpe}. Rio de Janeiro: LeYa, 2016.
\end{Parskip}