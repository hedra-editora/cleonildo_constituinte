...
do político com a do juiz. Entretanto, desde o século XVI, com o
...
Também Celso de Mello, ministro do STF, já se pronunciou sobre o
...
ação persecutória do Ministério Público.\footnote{SCARPINO, Luiz\emph{.}
  ...
  do STF. Logo, não foi possível consulta-la em sua integralidade.}
\end{quote}
...
Via de regra, o STF mantém as prisões decretadas por Moro e também
...
Segundo Jessé Souza\footnote{SOUZA, Jessé. \textbf{A radiografia do
...
profissional, consubstanciada nas práticas anti-corruptivas. Para que a
...
decorrência da atuação ativista dos juízes ou de autocontenção do STF,
...
1. BARROSO, Luís Roberto\emph{.} \textbf{Constituição, democracia e
supremacia judicial: Direito e Política no Brasil Contemporâneo}.
Revista da Faculdade de Direito da UERJ, n.21, Rio de Janeiro, 2012.
Disponível em:
...
2. CALAMANDREI, PIERO. \textbf{Eles, os juízes, vistos por um advogado}.
São Paulo, SP: Martins Fontes, 1995;

3. GHIRARDI, André Garcez. \textbf{Petrobrás as causas da crise além da
...
4. JORG, Janes e CARVALHO, Marcelo S. de. Os trabalhadores diante da
...
5. LIMA, Flávia Danielle Santiago. \textbf{ATIVISMO E AUTOCONTENÇÃO NO
SUPREMO TRIBUNAL FEDERAL: uma proposta de delimitação do debate.}
Repositório Institucional da UFPE, fevereiro de 2013. Disponível em:
{\emph{\textless{}}\url{http://repositorio.ufpe.br/handle/123456789/10958}\emph{\textgreater{}}}.
Acesso em setembro de 2016.

6. NETTO, Vladimir\emph{.} \textbf{Lava Jato. O juiz Sérgio Moro e os
bastidores da operação que abalou o Brasil}. Rio de Janeiro, RJ:
Primeira Pessoa, 2016.

7. SCARPINO, Luiz\emph{.} \textbf{Sérgio Moro: o homem , o juiz e o
Brasil}. Ribeirão Preto, SP: Novo Conceito, 2016.

8. SOUZA, Jessé. \textbf{A radiografia do golpe.} Rio de Janeiro, RJ:
LeYa, 2016
