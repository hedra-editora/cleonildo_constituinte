...
*Sociólogo formado pela Universidade de São Paulo (\versal{USP}), onde também
...
\textbf{\versal{FHC}:} Na verdade a decisão de me colocar como Relator do
...
\textbf{\versal{FHC}:} O presidente da Comissão foi o senador Affonso Arinos
...
-- entre eles os deputados} Roberto Cardoso (\versal{PMDB}"-\versal{SP}), \textbf{José
...
\textbf{\versal{FHC}:} Acontece o seguinte, o grande partido era o \versal{PMDB}, ele era
...
\textbf{\versal{FHC}:} O que aconteceu foi uma disputa de poder. O presidente
...
\textbf{\versal{FHC}:} É. Isso resultou no \versal{PSDB}. Foi o começo do que terminou na
...
\textbf{\versal{FHC}:} A questão central, que mais nos irritou, foi a da reforma
...
\textbf{O clima entre o governo Sarney e a \versal{ANC}, que já era complicado,
...
\textbf{\versal{FHC}:} Havia razões programáticas, porque nós achávamos que as
...
\textbf{Sobre a criação do \versal{PSDB}, o senhor foi, junto com o Mário Covas,
...
\textbf{O senhor foi Constituinte ao lado do Covas (\versal{PMDB}"-\versal{SP}), José Serra
...
*Advogado e professor universitário, filiou"-se à \versal{ARENA} ainda na
...
posteriormente no \versal{PFL}) como vice na chapa de Tancredo Neves (\versal{PMDB}"-\versal{MG}). A
...
\textbf{Depois vocês terminaram criando o \versal{PFL}.}
...
\textbf{Maciel:} Eu acho que ele foi procurado pelo pessoal do \versal{PSDB}, por
...
(\versal{PFL}"-\versal{MS}).} \textbf{Disseram que foram comer um Pato a Zé Lourenço
...
\textbf{Maciel:} É verdade, mas ele não saira do \versal{PDS}. Tancredo nos
...
*Profissional de letras, iniciou sua carreira política no \versal{PSD} sendo
...
\textbf{A relação política do governo Sarney (\versal{PMDB}"-\versal{MA}) com a Assembleia
...
\textbf{O regimento da \versal{ANC} acolheu o pedido do Plenário Nacional em prol
...
\textbf{A \versal{ANC} foi instalada numa conjuntura de crise de sustentação do
governo Sarney e marcada pela crise do \versal{PMDB}?}

\textbf{Jobim:} A crise do \versal{PMDB} e a crise do governo Sarney eram:
...
\textbf{Na partilha dos cargos, dos 132 cargos existentes coube ao \versal{PMDB}
...
Com a fundação do \versal{PSDB} o senhor assumiu a liderança do \versal{PMDB}. Como foi
esse processo?
...
*Advogado, foi deputado federal pelo \versal{PMDB} por cinco legislaturas
...
*O advogado iniciou sua vida pública como deputado estadual pelo \versal{MDB}
...
\textbf{Durante os 20 meses de Assembleia Nacional Constituinte o \versal{PMDB}
viveu a dúvida de ``ser ou não ser governo''. A questão partidária
exercia ou não influência nas votações em plenário?}

\textbf{Lyra:} O \versal{PMDB} sempre foi dividido. Quando eu cheguei lá, em
...
\textbf{No primeiro momento o \versal{PCB}, o \versal{PT} e o \versal{PC}do\versal{B} formaram um bloco de
...
\textbf{Em março a liderança do \versal{PFL} ficou com José Lourenço. No \versal{PDS}
...
\textbf{Na partilha dos cargos, ocorreu um grande acordo entre \versal{PMDB} e
...
\textbf{Após esse acordo de Mário Covas e José Lourenço, o \versal{PFL} se deu
...
\textbf{Freire:} Era o normal. O líder do \versal{PMDB} era o Mário Covas e o
...
\textbf{A \versal{ANC} aprovou o fortalecimento do Congresso, visto que ele
...
\textbf{O \versal{PCB} e os outros partidos que votaram pela aprovação da
...
\textbf{O \versal{PT} teve dificuldade de dialogar com os vários grupos?}
...
\textbf{Freire:} Com exceção do \versal{PDT}. Leonel Brizola era presidente do
...
\textbf{O \versal{PT} e o \versal{PDT} não votaram no parlamentarismo e nem defendiam a
...
\textbf{Durante a \versal{ANC} houve um momento tenso. Terminados os trabalhos da
...
\textbf{Havia vários grupos: \versal{MUP}, centrinho e outros. Como eles se
...
\textbf{Esse foi primeiro embate político dos partidos de esquerda \versal{PCB},
...
*Engenheiro pela \versal{UFPE}, inicia a militância no movimento estudantil Ação
...
\textbf{Senador, já na instalação da \versal{ANC}, em 1° de Fevereiro de 1987,
...
\textbf{A Emenda Popular elaborada pelo} \versal{DIAP} (Departamento
...
\textbf{No âmbito da \versal{ANC}, quais disputas foram as mais ferrenhas, que
...
\textbf{O \versal{PMDB} possuía 306 deputados. Se o \versal{PMDB} quisesse fazer uma
...
\textbf{Voltando ao \versal{PMDB}, fale um pouco sobre as tendências do partido.}
...
\textbf{Sendo as maiores bancadas na \versal{ANC} as do \versal{PMDB} e do \versal{PFL}, os
...
\textbf{No inicio dos trabalhos o deputado Fernando Lyra (\versal{PMDB}"-\versal{PE}), que
...
\textbf{Por que o \versal{PT} não assinou a Carta?}
...
\textbf{Todos os deputados do \versal{PT} assinaram?}
...
\textbf{Por que o \versal{PT} fechou na questão do presidencialismo e não do
parlamentarismo?}
...
\textbf{Havia a \versal{CUT}, a \versal{CGT}, a \versal{CONTAG} e vários sindicatos. Na defesa dos
...
\textbf{A campanha que a \versal{CUT} fez contra os deputados constituintes que
...
\textbf{Meneguelli era o presidente da \versal{CUT} e você o presidente do
