...
que a Benedita da Silva (\versal{PT}"-\versal{RJ}) fez...
...
\versal{PDT}... E cada grupo, cada partido desses, viabilizava e era veículo de
interesse de outros que estavam atrás da reforma agrária. Havia o \versal{PFL}, o
\versal{UDR} veiculando suas pretensões via \versal{PFL}... Também negociamos com gente do
...
\versal{PMDB}: Affonso Arinos (\versal{PFL}"-\versal{RJ}), Ulysses Guimarães (\versal{PMDB}"-\versal{SP})... Eu fui um
...
o \versal{PMDB}, a Constituinte... Mas ele cumpriu um papel histórico. Se eu
