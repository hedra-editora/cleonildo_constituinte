...
\versal{FERNANDO HENRIQUE CARDOSO}: Foi muito confuso. Havia ali um
...
\emph{O clima entre o governo Sarney e a \versal{ANC}, que já era complicado,
...
\emph{Sobre a criação do \versal{PSDB}, o senhor foi, junto com o Mário Covas,
...
\emph{O senhor foi Constituinte ao lado do Covas (\versal{PMDB}"-\versal{SP}), José Serra
...
\emph{Depois vocês terminaram criando o \versal{PFL}.}
...
\emph{A relação política do governo Sarney (\versal{PMDB}"-\versal{MA}) com a Assembleia
...
\emph{O regimento da \versal{ANC} acolheu o pedido do Plenário Nacional em prol
...
\emph{A \versal{ANC} foi instalada numa conjuntura de crise de sustentação do
...
\emph{Na partilha dos cargos, dos 132 cargos existentes coube ao \versal{PMDB}
...
\emph{Com a fundação do \versal{PSDB} o senhor assumiu a liderança do \versal{PMDB}. Como foi
esse processo?}
...
\emph{Durante os 20 meses de Assembleia Nacional Constituinte o \versal{PMDB}
...
\emph{No primeiro momento o \versal{PCB}, o \versal{PT} e o \versal{PC}do\versal{B} formaram um bloco de
...
\emph{Em março a liderança do \versal{PFL} ficou com José Lourenço. No \versal{PDS}
...
\emph{Na partilha dos cargos, ocorreu um grande acordo entre \versal{PMDB} e
...
\emph{Após esse acordo de Mário Covas e José Lourenço, o \versal{PFL} se deu
...
\emph{A \versal{ANC} aprovou o fortalecimento do Congresso, visto que ele
...
\emph{O \versal{PCB} e os outros partidos que votaram pela aprovação da
...
\emph{O \versal{PT} teve dificuldade de dialogar com os vários grupos?}
...
\emph{O \versal{PT} e o \versal{PDT} não votaram no parlamentarismo e nem defendiam a
...
\emph{Durante a \versal{ANC} houve um momento tenso. Terminados os trabalhos da
...
\emph{A Constituinte foi precedida por uma comissão chamada Affonso
...
\emph{Havia vários grupos: \versal{MUP}, centrinho e outros. Como eles se
...
\emph{Como ficou a situação das Forças Armadas dentro da nova
Constituição?}
...
da bancada do \versal{PT} com o outro vice"-líder, Plínio Arruda Sampaio (\versal{PT}"-\versal{SP}),
...
\emph{Esse foi primeiro embate político dos partidos de esquerda \versal{PCB},
...
no \versal{PMDB}, a ``tendência popular'': o \versal{PT}, o PCdoB, o \versal{PSB}. E esse bloco fez
uma articulação com o \versal{PMDB} liderado por Mário Covas (\versal{PMDB}"-\versal{SP}), Fernando
Henrique Cardoso (\versal{PMDB}"-\versal{SP}), Pimenta da Veiga (\versal{PMDB}"-\versal{MG}), Nelson Jobim
...
José Lourenço (\versal{PFL}"-\versal{BA}), e Mário Covas (\versal{PMDB}"-\versal{SP}) na questão das
...
\emph{Os temas: a natureza e finalidade do Estado, Conselho de
...
\emph{O Movimento nacional Pró"-participação Popular na Constituinte
...
\emph{O tema da reforma agrária foi uma derrota da esquerda?}
...
\emph{Senador, já na instalação da \versal{ANC}, em 1° de Fevereiro de 1987,
...
\emph{Como o senhor avalia a participação da sociedade civil organizada, que
...
\emph{Das propostas que as universidades defenderam, o que foi
...
\emph{Foi justamente nesse aspecto de crise econômica e política que
...
cabendo ao \versal{PMDB}, sob a liderança de Mário Covas (\versal{PMDB}"-\versal{SP}), encaminhar as
...
\emph{A Emenda Popular elaborada pelo \versal{DIAP} (Departamento
...
\emph{No âmbito da \versal{ANC}, quais disputas foram as mais ferrenhas, que
...
\emph{A Comissão de Sistematização analisa os trabalhos, consegue"-se
...
\emph{Outro fator de crise foi a disputa dos dois candidatos à
...
\emph{Instalada a Assembleia Nacional Constituinte em 1º de fevereiro,
...
\emph{O \versal{PMDB} possuía 306 deputados. Se o \versal{PMDB} quisesse fazer uma
...
\textbf{Egídio:} O \versal{PMDB} teve uma postura social e democrática em termos
...
\emph{Voltando ao \versal{PMDB}, fale um pouco sobre as tendências do partido.}
...
\emph{Dois temas recorrentes tomaram conta dos bastidores: a questão
...
\emph{Ainda sobre a questão do mandato de Sarney, que perdurou durante
...
\emph{Foram dois anos de Assembleia Nacional Constituinte, em várias
...
\emph{Nos embates no primeiro turno houve várias conquistas dos povos
...
\textbf{Paim:} Eu tive duas indicações, mas depois o \versal{PT} me deixou
...
\emph{Utilizou"-se muita coisa do anteprojeto elaborado pela Comissão
Affonso Arinos?}
...
\emph{Sendo as maiores bancadas na \versal{ANC} as do \versal{PMDB} e do \versal{PFL}, os
...
Fizemos uma parceria entre, principalmente, \versal{PMDB}, \versal{PDT}, \versal{PSB}, \versal{PTB}, PCdoB e
...
Dutra (\versal{PT}"-\versal{RS}), João Paulo, Covas(\versal{PMDB}"-\versal{SP}) e chegamos ao entendimento de
...
\emph{E como os Constituintes do campo mais conservador reagiram ao
...
\emph{No inicio dos trabalhos o deputado Fernando Lyra (\versal{PMDB}"-\versal{PE}), que
...
\emph{O jornalista Ricardo Noblat publicou na coluna dele no Jornal do
...
\emph{Por que o \versal{PT} não assinou a Carta?}
...
\emph{Todos os deputados do \versal{PT} assinaram?}
...
\textbf{Paim:} Minha posição é clara e é também a posição também do \versal{PT}:
...
\emph{Por que o \versal{PT} fechou na questão do presidencialismo e não do
parlamentarismo?}

\textbf{Paim:} No \versal{PT} não foi uma opção fechada. Eu, por exemplo, sempre
...
\emph{Vinte anos após a Assembleia Nacional Constituinte ainda há
...
\emph{No mês de maio o movimento sindical encaminhou suas propostas
...
\emph{Havia a \versal{CUT}, a \versal{CGT}, a \versal{CONTAG} e vários sindicatos. Na defesa dos
...
\emph{A campanha que a \versal{CUT} fez contra os deputados constituintes que
...
\emph{Meneguelli era o presidente da \versal{CUT} e você o presidente do
...
\emph{A Constituição é de fato cidadã, como falou o Ulysses Guimarães
ao promulgar?}
