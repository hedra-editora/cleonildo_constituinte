...
presidente Sarney (\versal{PMDB}"-\versal{MA}) sofria várias críticas e a Folha de S. Paulo
...
Lourenço (\versal{PFL}"-\versal{BA}), Fernando Lyra (\versal{PMDB}"-\versal{PE}), Carlos Santana (\versal{PMDB}"-\versal{BA}).
...
do \versal{PMDB}, grupo dirigido e liderado por Carlos Santana (\versal{PMDB}"-\versal{BA}), o líder
...
entenderam. E a maioria dos relatores que o \versal{PMDB} indicou era
...
chamados setores progressistas, com as indicações do \versal{PMDB}. Apesar haver
...
O \versal{CEAC} reuniu alunos, professores e funcionários da \versal{UNB}. Contou também
...
\versal{JOSÉ GENOÍNO}: Fiz parte da Comissão Sistematização e fui vice"-líder
...
do \versal{PT}, esse relatório foi derrotado aprovou"-se outro relatório, que foi
...
\noindent\emph{Esse foi primeiro embate político dos partidos de esquerda \versal{PCB},
...
Neves (\versal{PMDB}"-\versal{MG}) e pela a união do \versal{MDB} em torno de Tancredo -- houve
...
Arena, ja tinha aderido a eleição de Tancredo\ldots{} então a crise política
...
\versal{PMDB}: Affonso Arinos (\versal{PFL}"-\versal{RJ}), Ulysses Guimarães (\versal{PMDB}"-\versal{SP})\ldots{} Eu fui um
...
que queriam a democracia, lutavam por ela e que se o uniram ao \versal{PMDB},
...
estavam no \versal{PFL}, outros no \versal{PT} e porque que outros estavam se articulando
