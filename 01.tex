...
\versal{DANC} -- Diário da Assembléia Nacional Constituinte
...
\chapter{Marco Maciel\footnote{Advogado e professor universitário, filiou"-se à \versal{ARENA} ainda na
...
\versal{ANC} no desenvolvimento do Nordeste, o senhor lutou pela a aprovação
...
Cardoso. O \versal{PSDB} nasceu das divergencias nesses três estados, não havia
...
tenho direito só a aposentadoria do \versal{INSS}''.
...
proporcionalidade. Nós (\versal{PCB}), o \versal{PC}doB e o \versal{PSB} fizemos parte da comissão
