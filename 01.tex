...
mais liberal e democrática que o país já teve, merecendo o nome de
``Constituição Cidadã''. As entrevistas que seguem, baseadas no documentário \emph{Constituinte 1987--1988}, desvendam os bastidores do processo de elaboração da Constituição Brasileira.

Os relatos inéditos revelam como tudo ocorreu.
Entre as várias etapas, expõem episódios do governo Sarney e sua
...
Há também o registro de quando o \versal{PT} (Partidos dos Trabalhadores) votou
contra a redação final da Carta e a assinatura do documento, além de
uma análise atual dos entrevistados sobre a Constituição.
...
mandatos de \versal{FHC}, Lula e da presidenta Dilma Roussef; do deputado
...
\versal{FHC} relata a formação das várias comissões que contavam com a participação
...
O ex"-presidente \versal{FHC} lembra também que a~Constituinte~brasileira se
...
grande partido da época, o \versal{PMDB}, ``era o majoritário, mas não possuía
coesão'', como lembra \versal{FHC}. O Mário Covas foi uma das figuras mais
...
bloco do \versal{PMDB} que contava com \versal{FHC}, Nelson Jobim e Pimenta da Veiga.

O deputado constituinte Paulo Paim (\versal{PT}) destaca a parceria feita pelo \versal{PT}
com o \versal{PMDB} e cita Mário Covas e Ulysses Guimarães como importantes
aliados.

Entre os diversos depoimentos há relatos do cientista político David
Fleischer. Através de suas pesquisas, revela que o \versal{PMDB} não era o maior
partido da~Constituinte, mas sim a Arena.~Afirma que muitos políticos
passaram, na sua origem, pela Arena, \versal{PDS} e, depois, pelo \versal{PMDB}, por pura
conveniência para fins eleitorais. Fleischer também cita o surgimento do
\versal{MUP}, Movimento de Unidade Progressista, que teria reunido cerca de 100
deputados.
...
Mauro Benevides, à época deputado~constituinte~pelo \versal{PMDB}, relata as
...
O então reitor da Universidade de Brasilia (\versal{U}n\versal{B}), Dr. Cristovam
...
O então presidente da Central Única dos Trabalhadores (\versal{CUT}), Jair
...
Através das entrevistas, analisa"-se o trabalho de todas as
...
\versal{FHC}, Lula, Roberto Freire.

Freire foi ardoroso defensor do parlamentarismo. ``Acredito ser o regime
que, mesmo ante cenários de instabilidades governamentais, não se
correria o risco de sofrer restrições nas liberdades democráticas do
povo''. O deputado José Genoíno lembra que o \versal{PT} se pronunciou favorável
...
Freire revela o arrependimento por seu então partido \versal{PCB} haver
``embarcado'' com o \versal{PT} e o \versal{PDT} na disputa pelo mandato presidencial de
...
do parlamentarismo''. Freire lembra ainda que tanto o \versal{PT} como o \versal{PDT}
...
liberação de concessões de canais de rádio e \versal{TV}.~``Quase todos os
...
do \versal{PMDB}, do \versal{PFL}, do \versal{PDS} e do \versal{PTB}, além de partidos menores.
...
muitos tapas e ``microfones voando''.~O então líder sindical Vicentinho
...
As entrevistas também abordam detalhadamente o porquê de o \versal{PT} haver votado
...
trabalhadores'', diz ele, à época líder do \versal{PT}. Em seguida, recorda que
...
A íntegra de todas as entrevistas que compõem o filme \emph{Constituinte:
...
David Fleischer) foi transcrita nesta sessão que
...
\chapter{Fernando Henrique Cardoso\footnote{Sociólogo formado pela Universidade de São Paulo (\versal{USP}), onde também
lecionou, Cardoso exerceu o cargo de senador entre 1983 e 1992. Eleito
pelo \versal{PMDB}, fundou o \versal{PSDB} (1988) em meio ao processo constituinte
...
\hedramarkboth{Entrevista -- Fernando Henrique Cardoso}{}

\emph{\versal{CLEONILDO CRUZ:} Presidente Fernando Henrique Cardoso, vamos mergulhar na
história e falar sobre a abertura da Assembleia Nacional Constituinte,
em 1987. No dia 1º de fevereiro é instalada a \versal{ANC}. O governo do então
presidente Sarney (\versal{PMDB}"-\versal{MA}) sofria várias críticas e a \emph{Folha de S. Paulo}
noticiava: ``Crise marca a abertura da Constituinte''. Como foi a abertura
dos trabalhos?}

\noindent\versal{FERNANDO HENRIQUE CARDOSO}: Foi muito confuso. Havia ali um
momento de muita dificuldade. Primeiro porque o governo era de
transição. Havia morrido o Tancredo Neves (\versal{PMDB}"-\versal{MG}), que fora eleito
...
\versal{PMDB} para ser presidente. Até então ele era do outro lado, então havia
...
agrado deles. Foi assim até que o Ulysses Guimarães (\versal{PMDB}"-\versal{SP}), a grande
...
disputas partidárias e ideológicas no âmbito da \versal{ANC}?}

Na verdade a decisão de me colocar como Relator do
regimento interno foi do Ulysses Guimarães, que tinha todo o poder na
Câmara e no Congresso. E eu era líder do \versal{PMDB} no Senado e tinha um
relacionamento fluído com ele. Eu chamei imediatamente o deputado Nelson
Jobim (\versal{PMDB}"-\versal{RS}) para relator"-substituto, porque era um jovem advogado,
muito ligado à \versal{OAB}, que tinha posições muito claras sobre a questão da
Constituinte.
...
(\versal{PMDB}"-\versal{SP}), e só ele poderia determinar quem seria de que Comissão. A
...
submetido ao plenário da \versal{ANC}. No processo de definição desta comissão
houve vários momentos de tensão. Quais foram os mais complicados?}

O presidente da Comissão foi o senador Affonso Arinos
(\versal{PFL}"-\versal{RJ}), que era um homem respeitado por todos nós. O vice"-presidente
era o Aluízio Campos (\versal{PMDB}"-\versal{PB}). Os dois eram pessoas de idade avançada.
...
senador Jarbas Passarinho (\versal{PSD}"-\versal{PA}) e eu fomos eleitos vice"-presidentes
...
o deputado Bernardo Cabral (\versal{PMDB}"-\versal{AM}), um homem que variava de posição
...
Bernardo Cabral e líder do \versal{PMDB}. Então eu tinha muitas
responsabilidades.
...
-- entre eles os deputados Roberto Cardoso (\versal{PMDB}"-\versal{SP}), José
Lourenço (\versal{PFL}"-\versal{BA}), Fernando Lyra (\versal{PMDB}"-\versal{PE}), Carlos Sant'anna (\versal{PMDB}"-\versal{BA}).
Havia o grupo do consenso esquerda positiva, do qual o senhor fez parte
com o deputado Euclides Scalco (\versal{PMDB}"-\versal{PR}). No grupo conservador havia o
Israel Pinheiro (\versal{PMDB}"-\versal{MG}). Como se dava a engenharia desses grupos? Por
que a questão partidária ficou de lado e os grupos eclodiram no seio da
\versal{ANC} e as discussões deixaram de ser entre partidos, mas entre grupos?}

Acontece o seguinte, o grande partido era o \versal{PMDB}, ele era
...
partidos. O José Richa (\versal{PMDB}"-\versal{PR}) era muito importante, porque fazia a
...
(\versal{PMDB}"-\versal{SC}), eu, o Nelson Jobim, o Miro Teixeira (\versal{PMDB}"-\versal{RJ}) e vários outros
...
sessão simultânea da Comissão de Sistematização, e do Plenário da \versal{ANC},
...
grande do governo para puxar para o lado dele. E aí esqueceu"-se de \versal{PMDB},
\versal{PFL}, o que fosse. Ficou governo e não"-governo, mas só mesmo nessa
...
É. Isso resultou no \versal{PSDB}. Foi o começo do que terminou na
criação do \versal{PSDB}. Não dava para apoiar um governo que não aceitava uma
...
agrária, porque era um programa do \versal{PMDB}. E na hora da votação as pessoas
...
\noindent\emph{O clima entre o governo Sarney e a \versal{ANC}, que já era complicado,
...
coisas não estavam indo para o lado do programa do \versal{PMDB}. E havia razões
...
muito natural. Ele era o presidente do \versal{PDS}, o partido que sustentava o
...
do \versal{PMDB}, ou seja: todos, menos o Francisco Dornelles (\versal{PFL}"-\versal{RJ}). Era uma
...
Amazonas, do \versal{PC}do\versal{B}, para ir tomar um café lá no Palácio da Alvorada.
...
\noindent\emph{Sobre a criação do \versal{PSDB}, o senhor foi, junto com o Mário Covas,
...
eu fui me despedir do Ulysses dizendo que eu sairia do \versal{PMDB} -- eu era
...
``autênticos'' do \versal{PMDB}, que já tinha outro nome àquela altura, não queria
que o Mário saísse, mas que fosse candidato à Presidência da República
pelo \versal{PMDB}. Mas a maioria não apoiaria o Mário, então pressionaram. O
Mário no último momento decidiu pelo \versal{PSDB}. Ele tinha visto que não havia
mais saída.

Sem o Mário nós não teríamos feito o \versal{PSDB}, porque nós precisávamos de um
...
reabertura política. Com o \versal{MDB} e a eleição de vários senadores, a luta
...
Eu não tenho dúvida. Tenho 81 anos e quando eu nasci, isso
...
(1964-85), fundador do \versal{PT} (1980) e da \versal{CUT} (1983), tornou"-se o primeiro
operário a assumir a Presidência da República Federativa do Brasil
(2003-2010).}}
\hedramarkboth{Entrevista -- Luiz Inácio Lula da Silva}{}

\emph{\versal{ENTREVISTADORES}: O senhor tinha 43 anos e exercia o seu primeiro cargo público
...
\versal{LUIZ INÁCIO LULA DA SILVA}: Primeiro é importante lembrar que o
\versal{PT} possuía, na época, apenas 16 deputados e que nós chegamos na
...
queríamos estava muito distante. Fato concreto é que o \versal{PT} não aprovou a
Constituição. O \versal{PT} votou contra a Constituição e há uma confusão que de
vez em quando dizem que o \versal{PT} não assinou. O \versal{PT} assinou.
...
na hora de votar houve uma discussão dentro do \versal{PT}: ``Assina ou não
...
eu diria o que disse Ulysses Guimarães (\versal{PMDB}"-\versal{SP}) num pronunciamento às
...
\noindent\emph{O senhor foi constituinte ao lado do Covas (\versal{PMDB}"-\versal{SP}), José Serra
(\versal{PMDB}"-\versal{SP}), \versal{FHC} (\versal{PMDB}"-\versal{SP}). Na época, a democratização da política
...
o Fernando Henrique Cardoso, o Serra, quando deixaram o \versal{PMDB}, estavam
...
Genoíno (\versal{PT}"-\versal{SP}) e Plínio de Arruda Sampaio (\versal{PT}"-\versal{SP}). Fomos conversar com
Nelson Carneiro (\versal{PMDB}"-\versal{RJ}) sobre se entrava Jesus Cristo na Constituição
...
que a Benedita da Silva (\versal{PT}"-\versal{RJ}) fez\ldots{}
...
(\versal{PFL}"-\versal{PR}) sobre a questão da licença"-paternidade. Era algo que,
...
maravilhosa. Ulysses Guimarães (\versal{PMDB}"-\versal{SP}), por exemplo. Às vezes falo que
...
fosse candidato e recusei, também porque queria dar uma lição no \versal{PT}.
...
gente aprovar. Chegava na bancada do \versal{PT}, a briga estava mais forte,
...
\chapter{Marco Maciel\footnote{Advogado e professor universitário, Maciel filiou"-se à \versal{ARENA} ainda na
...
\hedramarkboth{Entrevista -- Marco Maciel}{}

\emph{\versal{CLEONILDO CRUZ}: Marco Maciel, a Frente Liberal liderada pelo senhor foi criada
como uma dissidência do \versal{PDS} e indicou José Sarney (então no \versal{PDS},
posteriormente no \versal{PFL}) como vice na chapa de Tancredo Neves
(\versal{PMDB}"-\versal{MG}). A articulação da Frente já tinha em vista
esta indicação?}

\versal{MARCO MACIEL}: Na verdade o que nós fizemos foi algo mais amplo,
de grande impacto político. Nós queríamos dar um novo rumo ao processo
sucessório, porque Paulo Maluf (\versal{PDS}) se lançara candidato e empolgara
grande parte do então \versal{PDS}. Como atitude de reação nós organizamos um
...
\noindent\emph{Depois vocês terminaram criando o \versal{PFL}.}

Exatamente. Houve na sequência a conversão da Frente
Liberal no Partido da Frente Liberal. O passo mais lógico era também
fazer um entendimento com o \versal{PMDB}, que se deu primeiramente no
apartamento do Sarney. Um dia eu fui à casa do Sarney e me encontrei com
Ulysses Guimarães, que era o presidente do \versal{PMDB}. Então nós acertamos que
...
do \versal{PMDB}. O Tancredo Neves brotou candidato naturalmente porque era tido
...
terminou sendo José Sarney. Ele, inclusive, era o presidente do \versal{PDS}, mas
deixou a Presidência do \versal{PDS} e passou a integrar a nossa coligação.
...
Aliança Democrática, que reunia o \versal{PMDB} e a Frente Liberal.
...
pessoas: Ulysses e Tancredo pelo \versal{PMDB}, Aureliano e eu pela Frente
...
Câmara dos Deputados. Em 1985, já sabendo"-se que haveria a \versal{ANC} em 1987,
...
José Carlos Moreira Alves (\versal{STF}) abriu, José Genoíno (\versal{PT}"-\versal{SP}) e Roberto
Freire (\versal{PCB}"-\versal{PE}) se pronunciaram pedindo a impugnação de 23 senadores
...
Lucena (\versal{PMDB}"-\versal{PB}), que era o presidente do Senado à época. Ele era
...
Eu acho que ele foi procurado pelo pessoal do \versal{PSDB}, por
...
Mário Covas foi para o Restaurante Piantelo. E o bloco do \versal{PFL}, que o
senhor defendia havia 4 anos, foi para casa do deputado Saulo Queiroz
(\versal{PFL}"-\versal{MS}). Disseram que foram comer um Pato a Zé Lourenço
(\versal{PFL}"-\versal{BA}). O senhor e o Aureliano Chaves (ministro de Minas e Energia,
\versal{PFL}) não foram, mas houve essa comemoração dos dois lados. A razão dessa
vitória era a campanha de Aureliano Chaves para presidente? O \versal{PFL} já
trabalhava com essa perspectiva?}

Nós pensamos na candidatura de Aureliano antes daquele
entendimento com Tancredo, àquela época. No \versal{PDS} havia mais quatro
...
(\versal{PFL}"-\versal{BA}), responsável pela distribuição de concessões de rádio e \versal{TV}, e
não o presidente nacional do partido. Quem realmente mandava no \versal{PFL}?
...
Liberal. Antônio Carlos só passou para o \versal{PFL} mais de um ano depois. Eu
...
quando \versal{ACM} disse: ``Estou achando que não devo continuar no \versal{PDS}, eu
gostaria de passar a integrar a aliança que apoiava Sarney'' e que era o
\versal{PFL}. A partir daí ele veio para as nossas hostes.

\medskip

\noindent\emph{Eles já não estavam apoiando o Tancredo?}

É verdade, mas ele não saira do \versal{PDS}. Tancredo nos
comícios disse assim: ``Estou aqui com os meus colegas, meus
companheiros do \versal{PMDB}, com meus companheiros do \versal{PFL} e os dissidentes do
\versal{PDS}''. Os ``dissidentes'' do \versal{PDS},
no caso, era Antônio Carlos. Ele não foi
para o \versal{PFL} no primeiro momento. No entendimento que ele fez com
...
que ajudou o grupo em torno do \versal{PFL} a aprovar os cinco anos e zerou tudo,
como se deu a formação desse bloco e qual o papel de Ricardo Fiúza
(\versal{PFL}"-\versal{PE}) nessa articulação? }
...
\chapter{Mauro Benevides\footnote{Profissional de letras, iniciou sua carreira política no \versal{PSD} sendo
...
(1964-1985) levou"-o ao \versal{MDB}, partido pelo qual foi senador (1975-1982 e
1987-1994) e deputado federal (2007-2014).}}
\hedramarkboth{Entrevista -- Mauro Benevides}{}

\emph{\versal{CLEONILDO CRUZ}: A Assembleia Nacional Constituinte foi instalada no dia 1º de
...
\versal{MAURO BENEVIDES}: Naturalmente, no primeiro momento, o presidente José
...
que seria Constituinte, Affonso Arinos (\versal{PFL}"-\versal{RJ}), foi oferecida.
...
do pronunciamento do ministro José Carlos Moreira Alves (\versal{STF}), que, como
...
\noindent\emph{A relação política do governo Sarney (\versal{PMDB}"-\versal{MA}) com a Assembleia
...
licença"-paternidade, de autoria do deputado Alceni Guerra (\versal{PFL}"-\versal{PR}),
...
Guimarães (\versal{PMDB}"-\versal{SP}) rebate as críticas de Sarney contra a Constituição''.
...
\noindent\emph{O regimento da \versal{ANC} acolheu o pedido do Plenário Nacional em prol
...
deputado Cardoso Alves (\versal{PMDB}"-\versal{SP}), fez algumas imposições ao próprio
...
Lula (\versal{PT}). Todos os presidentes, a começar por José Sarney (\versal{PMDB}),
Fernando Collor (\versal{PRN}), Itamar (\versal{PMDB}), Fernando Henrique Cardoso (\versal{PSDB}) e
...
\versal{ANC} no desenvolvimento do Nordeste, o senhor lutou pela aprovação
...
Financiamento do Nordeste (\versal{FNE}), no Fundo Constitucional de
Financiamento do Norte (\versal{FNO}) e no Fundo Constitucional de Financiamento
do Centro"-Oeste (\versal{FCO}). Tais fundos foram constituídos com o recurso do
Imposto sobre Produtos Industrializados (\versal{IPI}) e do Imposto de Renda
(\versal{IR}).
...
(\versal{BASA}) na região Norte, o Banco do Nordeste do Brasil (\versal{BNB}) na região
...
tendo como Relator o deputado Nelson Jobim (\versal{PMDB}"-\versal{RS}), que viria a ser
...
Tribunal Federal (1997-2006), ocupando a Presidência do \versal{STF} (2004-2006),
e ministro da Defesa (2007-2011).}}
\hedramarkboth{Entrevista -- Nelson Jobim}{}

\emph{\versal{CLEONILDO CRUZ}: A instalação da Assembleia Nacional Constituinte aconteceu em 1º
de fevereiro de 1987. O tema da soberania nacional foi bastante
debatido. Por quê?}

\versal{NELSON JOBIM}: Não era bem a soberania nacional. O que mais se debatia
...
\versal{OAB}, e, no final, quando o presidente Sarney mandou o projeto de emenda
constitucional que convocou a Assembleia Constituinte, o deputado Flávio
Bierrembach (\versal{PMDB}"-\versal{SP}), que fora relator da emenda constitucional em 1985,
...
Tanto é que eu apresentei, na bancada do \versal{PMDB}, dois projetos que eu
...
indireta pelo Plínio de Arruda Sampaio (\versal{PT}): o problema do terço do
...
era os eleitos de 1982. E o Plínio, que era líder do \versal{PT}, suscitou uma
...
\noindent\emph{A \versal{ANC} foi instalada numa conjuntura de crise de sustentação do
governo Sarney e marcada pela crise do \versal{PMDB}?}

A crise do \versal{PMDB} e a crise do governo Sarney eram:
primeiro, o Plano Cruzado fracassara, inclusive houve toda aquela
afirmação do Brizola (\versal{PDT}"-\versal{RJ}) na época, de que havia um estelionato
eleitoral, que o \versal{PMDB} ganhou as eleições de 1986 e a reforma do Plano
Cruzado só se deu depois das eleições. Quando começou o processo
Constituinte se estabeleceu, dentro do \versal{PMDB}, uma disputa. E essa disputa
era a seguinte: de um lado o presidente Sarney com o grupo ``sarneyista''
do \versal{PMDB}, grupo dirigido e liderado por Carlos Sant'anna (\versal{PMDB}"-\versal{BA}), o líder
do governo na Câmara. Do outro lado o doutor Ulysses e seu grupo, o qual
integrei. Eu fui do segundo time.

O conflito se deu primeiro na eleição do líder do \versal{PMDB} na Constituinte.
...
Ulysses teve uma disputa com o Fernando Lyra (\versal{PMDB}"-\versal{PE}), que decidira ser
...
Affonso Arinos (\versal{PFL}"-\versal{RJ}) como sugestão, como elemento de pesquisa, mas
...
Henrique (Cardoso, \versal{PSDB}) como relator do regimento interno. E a briga do
\versal{PMDB} era a briga Ulysses de um lado e Sarney do outro. Isso ficou muito
claro na luta da liderança do \versal{PMDB} na Constituinte. O Ulysses tinha um
candidato para ser líder do \versal{PMDB} na Constituinte e que era o líder do
\versal{PMDB} na Câmara, que era o Luíz Henrique da Silveira (\versal{PMDB}"-\versal{SC}), que viria
...
bancada em comum. Os senadores do \versal{PMDB} votaram no Mário Covas e a parte
...
\noindent\emph{Na partilha dos cargos, dos 132 cargos existentes coube ao \versal{PMDB}
...
A questão partidária era a disputa de Sarney. Ou melhor:
a disputa entre progressistas e conservadores, porque o \versal{PMDB} era um
...
condução do \versal{PMDB}, a condução do processo constituinte na Comissão de
...
pelo Centrão, principalmente pelo Gastone Righi (\versal{PTB}"-\versal{SP}), que foi quem
...
``\versal{DVS}'' -- Destaque para Votar em Separado. Ela analisava o texto ``x'' fora
...
político que foi discutido no seio da liderança do \versal{PMDB}, com o Mário
...
Não. Não trabalhávamos por sigla de partido, mas por
...
\versal{PMDB}, presidida pelo Mário Covas até que ele passou para o \versal{PSDB}. Lá na
liderança nós negociávamos toda a votação da tarde. Negociava com o \versal{PFL},
\versal{PDT}\ldots{} E cada grupo, cada partido desses, viabilizava e era veículo de
interesse de outros que estavam atrás da reforma agrária. Havia o \versal{PFL}, o
\versal{UDR} veiculando suas pretensões via \versal{PFL}\ldots{} Também negociamos com gente do
\versal{PMDB}, que era o caso do Cardoso Alves (\versal{PMDB}"-\versal{SP}), conhecido como
...
exemplo: o \versal{PMDB} teve na Constituinte acho que 230 deputados e senadores
...
da liderança do \versal{PMDB}, comandada pelo Mário Covas. Então ali você fazia
...
ele queria reduzir para cinco, enquanto o \versal{PMDB} queria reduzir para
quatro. O Mário Covas e o \versal{PMDB} queriam quatro.
...
José Richa (\versal{PMDB}"-\versal{SP}), que fora governador do Paraná e era muito amigo do
...
o Richa nos trouxe para submeter ao \versal{PMDB}: ele aceitava o parlamentarismo
...
maiores eram o senador Humberto Lucena (\versal{PMDB}"-\versal{PB}) e o Vivaldo Barbosa
(\versal{PDT}"-\versal{RJ}).
...
razão em relação ao ``\versal{DVS}'' -- Destaque para Votar em Separado.
...
e ao \versal{DVS}. Votamos e aprovamos a emenda do Centrão e fizemos um árduo
...
dentro do \versal{PMDB} para ver quem votava por 4 anos e quem votava por 5 anos,
um colega do \versal{PMDB} lá do Sul veio falar comigo. Ele exibiu uma série de
...
prefeitos de vários partidos, carta do diretório do \versal{PMDB} local, carta do
...
foi em 1989 e quem venceu foi o Collor (\versal{PRN}), que não tinha nada a ver
com a Constituinte.
...
Sarney a nós da maioria do \versal{PMDB}: a de ser aprovado o parlamentarismo em
...
reserva de informática. E algo precisa ficar claro: o \versal{PMDB} era um
partido que em seu bojo havia gente da esquerda, liberais e gente da
direita. Então o \versal{PMDB} nunca debatia muito a questão da ordem econômica,
...
\noindent\emph{Com a fundação do \versal{PSDB} o senhor assumiu a liderança do \versal{PMDB}. Como foi
esse processo?}
...
Pedro Simon e o Miguel Arraes. Eram o núcleo decisório do \versal{PMDB}. E havia
...
regra antiga que existia desde a Consolidação das Leis do Trabalho (\versal{CLT})
de Getúlio Vargas. O pessoal da esquerda, o Plínio de Arruda Sampaio
(\versal{PT}"-\versal{SP}), que viabilizava as pretensões e os interesses dos sindicatos,
...
O Mário Covas tinha como vice"-líder o Euclides Scalco (\versal{PMDB}"-\versal{PR}). E o
\versal{PSDB} surgiu por três pontos: a disputa por São Paulo, com Covas,
...
Cardoso. O \versal{PSDB} nasceu das divergências nesses três estados, não havia
nada de ideologia. O Mário Covas saiu para o \versal{PSDB} e eu me tornei líder
do \versal{PMDB} no final da Constituinte. Sobrou para mim. Quem deveria ser o
líder era o Antônio Brito (\versal{PMDB}"-\versal{RS}), mas ele saiu para disputar a
...
\chapter{Maurílio Ferreira Lima\footnote{Advogado, foi deputado federal pelo \versal{PMDB} por cinco legislaturas
...
\hedramarkboth{Entrevista -- Maurílio Ferreira Lima}{}

\emph{\versal{CLEONILDO CRUZ}: A instalação da Assembleia Nacional Constituinte se deu em que
contexto político?}

\versal{MAURÍLIO FERREIRA LIMA}: É preciso entender o contexto dentro do qual a
...
Mas na Assembleia Constituinte havia essa disposição: vamos botar na
...
meu amigo, por exemplo, Fernando Gasparian (\versal{PMDB}"-\versal{SP}), um dos homens mais
...
É porque as pessoas entendem que uma casa legislativa
...
Ulysses (\versal{PMDB}"-\versal{SP}). Se não fosse Ulysses Guimarães não teríamos feito a
...
havia votação. Há um deputado que faleceu, Amaury Muller (\versal{PDT}"-\versal{RS}), do
...
contratados pela \versal{CLT} (Consolidação das Leis do Trabalho) e os
contratados pelo regime jurídico do funcionalismo federal. Então,
lógico, eram dois tratamentos diferentes. Quem era contratado pela \versal{CLT}
era regido pela lei trabalhista. Na lei trabalhista você só se aposenta
com trinta e cinco anos de contribuição e naquele salário maior do \versal{INSS}
...
tenho direito só à aposentadoria do \versal{INSS}''.
...
da \versal{OAB} do Brasil. Só porque tem um título dá um tiro em alguém e quer
ficar num quartel folgado, com televisão de plasma ou \versal{LCD}, entendeu?
...
\chapter{Fernando Lyra\footnote{O advogado iniciou sua vida pública como deputado estadual pelo \versal{MDB}
...
grupo dos ``autênticos'' do \versal{PMDB}, partido do qual se desfiliou para
ingressar no \versal{PDT}, pelo qual disputou, em 1989, a Vice"-Presidência da
República na chapa de Leonel Brizola. Já filiado ao \versal{PSB}, voltou à Câmara
Federal em 1993, permanecendo até 1998. Presidiu a Fundação Joaquim
Nabuco (2003-2011). Faleceu em 2013.}}
\hedramarkboth{Entrevista -- Fernando Lyra}{}

\emph{\versal{CLEONILDO CRUZ}: Em julho de 1985, em pleno processo de transição democrática, o
...
\versal{FERNANDO LYRA}: A ideia da Comissão foi do doutor Tancredo Neves
(\versal{PMDB}"-\versal{MG}). Ele ainda candidato, nós conversamos muito, inclusive
chegamos a convidar o ex"-ministro Affonso Arinos (\versal{PFL}"-\versal{RJ}) para ser o
...
aceitasse e ele se elegeu. E a grande contribuição do \versal{PMDB} naquela
...
Aconteceu que a maioria ou a quase maioria do \versal{PMDB} queria quatro anos
...
(\versal{PDT}"-\versal{RJ}) -- e não sei o nome do partido que elegeu Pedro Collor e
...
de Tancredo foi consensual. Várias pessoas que antes eram \versal{PDS} criaram
...
(\versal{PDT}"-\versal{RJ}): 425 votos a 69. Mas a sua disputa foi para a Presidência da
...
eletivo, procurei verificar quem seriam os candidatos do \versal{PMDB}, que era o
...
Câmara, presidente da Constituinte e presidente do \versal{PMDB}. Ele era o
...
Não houve retaliação porque não tinha motivo algum. Pelo
...
lá dentro''. E botou Francisco Dornelles (\versal{PFL}"-\versal{RJ}), que era, além de
...
comissões e subcomissões, o Ulysses e o Bernardo Cabral (\versal{PMDB}"-\versal{AM})
rejeitaram a proposta do senador José Richa (\versal{PMDB}"-\versal{PR}) de suspender os
...
Não digo que a crise atrapalhou. O grande problema é que
...
\noindent\emph{Durante os 20 meses de Assembleia Nacional Constituinte o \versal{PMDB}
viveu a dúvida de ``ser ou não ser governo''. A questão partidária
exercia ou não influência nas votações em plenário?}

O \versal{PMDB} sempre foi dividido. Quando eu cheguei lá, em
...
lutávamos sempre e essa coisa não parou. Até que hoje, 2009, o \versal{PMDB} é
uma capitania hereditária. O que é capitania hereditária? Cada estado
tem o seu dono. O \versal{PMDB} daqui não tem nada a ver com o \versal{PMDB} de lá e nem
de acolá. Não existe partido nacional. Quem é o líder do partido do
\versal{PMDB}? Eu não conheço.
...
parlamentarista. Quando chegou na ``hora \versal{H}'' do voto, o presidencialismo
...
acontecer quando o relator e o líder do \versal{PMDB} adotaram posições
...
Gasparian (\versal{PMDB}"-\versal{SP}), uma figura extraordinária, que criou um artigo
...
sua carreira política no \versal{MDB}, posteriormente \versal{PMDB}, se desfiliando em
1985 para ingressar no \versal{PCB}, onde permaneceu até 1992, ano em que fundou
seu atual partido, o \versal{PPS}.}}
\hedramarkboth{Entrevista -- Roberto Freire}{}

\emph{\versal{CLEONILDO CRUZ}: Dr. Roberto Freire, no final de 1985 travou"-se um grande debate
...
o deputado Plínio de Arruda Sampaio (\versal{PT}"-\versal{SP}) levantaram, durante a
...
(\versal{PMDB}"-\versal{AM}) e o deputado Gastone Righi (\versal{PTB}"-\versal{SP}). Eles alegaram que os
senadores tinham poderes constituintes derivativos. Por que o
entendimento do \versal{PCB} e dos partidos de esquerda na época era que esses
senadores não deveriam participar da \versal{ANC}?}

\versal{ROBERTO FREIRE}: A ideia de Constituinte exclusiva ou congressual não
...
presidente, o Itamar Franco (\versal{PMDB}). Eu sempre tive uma ligação muito
...
\noindent\emph{No primeiro momento o \versal{PCB}, o \versal{PT} e o \versal{PC}do\versal{B} formaram um bloco de
...
partidos referenciados de esquerda. Houve o \versal{PSB} e o \versal{PDT}, que eram também
parte da esquerda, e um amplo setor no \versal{PMDB} que foi de fundamental
...
esquerda do \versal{PMDB}, liderado por Mário Covas e Fernando Henrique Cardoso.
...
Ao escolher esse mecanismo de articulação com a
...
achava que nós não deveríamos ser legais antes da convocação da \versal{ANC} e
...
\noindent\emph{Em março a liderança do \versal{PFL} ficou com José Lourenço. No \versal{PDS}
Amaral Neto, no \versal{PDT} Brandão Monteiro, no \versal{PTB} Gastone Righi, no \versal{PT} Luiz
Inácio, no \versal{PL} Adolfo Oliveira. A única alteração foi no \versal{PMDB}: Luiz
Henrique por Mário Covas. O Dr. Ulysses apoiava Luiz Henrique e Mário
Covas era apoiado pelo conjunto progressista do \versal{PMDB}. Esta foi uma
...
\versal{PMDB}, mas tinha uma relação muito estreita. Foi uma disputa entre
setores mais avançados do \versal{PMDB}, não uma disputa entre um setor mais à
esquerda e outro mais à direita. Foi uma disputa de influência dentro do
\versal{PMDB}, porque Luiz Henrique tem uma trajetória no \versal{PMDB} desde o grupo
...
\noindent\emph{Na partilha dos cargos, ocorreu um grande acordo entre \versal{PMDB} e
\versal{PFL}, orquestrado pelo líder do \versal{PMDB}, Mário Covas. Os partidos pequenos,
tanto de direita como de esquerda, reagiram. O senhor afirmou, na época,
que o \versal{PMDB} e o \versal{PFL} pretendiam usar o critério da proporcionalidade para
esmagar os partidos pequenos. Como ficou o \versal{PCB} na partilha?}
...
presença em todas. Nós vencemos essa questão porque Covas e o \versal{PMDB}
...
proporcionalidade. Nós (\versal{PCB}), o \versal{PC}do\versal{B} e o \versal{PSB} fizemos parte da Comissão
de Sistematização. Tanto é que vencemos quase tudo. E se fizer o
levantamento dos membros do \versal{PMDB} na Comissão de Sistematização, em sua
grande maioria foram, depois, formar o \versal{PSDB}, que era a ala à esquerda no
\versal{PMDB}. No final dos trabalhos da Comissão de Sistematização -- isso é um
dado importante -- a direita foi toda embora, ficando apenas José
Lourenço (\versal{PFL}"-\versal{BA}), Luiz Eduardo Magalhães (\versal{PFL}"-\versal{BA}) e Ricardo Fiúza
(\versal{PFL}"-\versal{PE}), só para votar e dizer que estavam discordando do que a maioria
...
\noindent\emph{Após esse acordo de Mário Covas e José Lourenço, o \versal{PFL} se deu
...
entenderam. E a maioria dos relatores que o \versal{PMDB} indicou eram
progressistas. Na sua opinião o poder de agenda na mão dos progressistas
foi maior?}

Era o normal. O líder do \versal{PMDB} era o Mário Covas e o
\versal{PMDB} possuía mais de dois terços da Assembleia Nacional Constituinte e,
como maioria, coube a ele indicar. E não era o uso da proporcionalidade.
Como possuía o maior partido, que era o \versal{PMDB}, e um líder progressista,
...
por Plínio de Arruda Sampaio (\versal{PT}"-\versal{SP}) e Egídio Ferreira Lima (\versal{PMDB}"-\versal{PE}),
...
\noindent\emph{A \versal{ANC} aprovou o fortalecimento do Congresso, visto que ele
perdera suas prerrogativas constitucionais durante a ditadura. Com a \versal{ANC}
ele passou a aprovar projetos de lei e convocar ministros. Foi fácil
aprovar o fortalecimento do Congresso Nacional?}

Foi e acho que exacerbamos. Colocamos na Constituição
...
importantes, como a presença de Mário Covas na liderança do \versal{PMDB}, a
...
chamados setores progressistas, com as indicações do \versal{PMDB}. Apesar de haver
...
embates. Talvez o maior impasse tenha sido com a \versal{UDR} no capítulo da
...
sem ter o mínimo de consenso. Poderia até fazer se houvesse um \versal{PMDB}
homogêneo, porque o \versal{PMDB} tinha dois terços do Congresso, mas não foi o
caso. As eleições de 1986, em cima do chamado ``êxito'' do Plano
Cruzado, deram ao \versal{PMDB} uma ampla maioria no Brasil. Mas o \versal{PMDB} era uma
frente, não um partido. Tanto é que você tinha o Roberto Cardoso Alves
(\versal{PMDB}"-\versal{SP}), representante do setor bem mais conservador, e os setores de
esquerda, que foram a formar o atual \versal{PSDB}. Era preciso ter capacidade de
articular as várias forças políticas. Contarei um fato interessante: o
Virgílio Távora (\versal{PDS}"-\versal{CE}) era chamado de um dos coronéis do Ceará, mas
...
na reunião das esquerdas, na \versal{CNBB} (Confederação Nacional de Bispos do
...
Caiado, líder da \versal{UDR}, desempenhou um papel muito forte articulando os
ruralistas.
...
Naquele momento houve choques inclusive de
...
partido de esquerda, como Lúcio Alcântara (\versal{PFL}"-\versal{CE}), que foi prefeito de
...
``crimes de sangue'', da luta armada. Em 1979 só havia \versal{MDB} e Arena. Mas
dentro do \versal{MDB} já havia os vinculados ao \versal{PC}do\versal{B} e à formação do \versal{PT}.
Cristina Tavares (\versal{MDB}"-\versal{PE}), por exemplo, foi muito atuante e só aceitava
a anistia ampla, geral e irrestrita, assim como Teotônio Vilela
(\versal{MDB}"-\versal{AL}). Eu lembro de um debate em que disse que iriamos votar em
...
trabalhos. Não vamos esquecer que o \versal{PT}, através de Lula, votou contra o
texto constitucional.

\medskip

\noindent\emph{O \versal{PCB} e os outros partidos que votaram pela aprovação da
Constituição o que pensaram sobre o posicionamento do \versal{PT}, que votou
contra?}
...
O \versal{PC}do\versal{B} fez um discurso dizendo que era um discurso ``frankenstein''.
Haroldo Lima (\versal{PC}do\versal{B}"-\versal{BA}) afirmou que era ``uma loucura'', porque era uma
...
através da política, com o \versal{PMDB}. Houve incompreensão de alguns setores
da esquerda sobre os avanços que estávamos fazendo. Depois, na questão
do impeachment de Collor (\versal{PRN}"-\versal{AL}), de que participamos todos juntos, o
\versal{PT} não participou quando formamos o governo que surgiu.

\medskip

\noindent\emph{O \versal{PT} teve dificuldade de dialogar com os vários grupos?}
...
naquele momento. O \versal{PT} possuía pessoas ótimas, mas, como um todo, era
...
Mas não conseguimos convencê"-los. E o drama é que o \versal{PT} era dividido.
Nessa disputa você tinha uma grande líder do ensino religioso, a Sandra
Cavalcanti (\versal{PFL}"-\versal{RJ}), membro dessa comissão. Eu no debate contava com
Florestan Fernandes (\versal{PT}"-\versal{SP}). Mas havia um setor do \versal{PT} que se aliava com
a Sandra. O \versal{PT} é um pouco isso. E na questão do parlamentarismo, por
exemplo, nós perdemos por o \versal{PT} imaginar que Lula chegaria à Presidência
...
Com exceção do \versal{PDT}. Leonel Brizola era presidente do
...
Sarney, que era de seis anos e ficou em cinco. O \versal{PT} e o \versal{PDT} queriam
...
Não admitimos fazê"-lo, mas existia essa possibilidade.
Sarney não é presidencialista, tendia ao parlamentarismo. Ulysses também
não era presidencialista e estava como um árbitro naquilo. O \versal{PT} e o \versal{PDT},
...
\noindent\emph{O \versal{PT} e o \versal{PDT} não votaram no parlamentarismo e nem defendiam a
...
parlamentarismo talvez valesse a pena. Mas ficamos com o \versal{PT} e o \versal{PDT} nos
...
Isso deve ser bem contextualizado. Nós, os comunistas
do \versal{PCB} e do \versal{PC}do\versal{B}, e também outros setores de esquerda, ainda vivíamos
num mundo bipolar. A União Soviética ainda existia e, naquele momento, o
\versal{PCB} era um dos partidos do movimento comunista internacional -- embora
...
\versal{PT}, tinham como o referencial da esquerda aquilo que era o tipo de
...
\hedramarkboth{Entrevista -- David Fleischer}{}
...
\versal{DAVID FLEISCHER}: A Constituinte eleita em 1986 foi uma grande vitória
do \versal{PMDB}. Naquela eleição o partido elegeu os governadores de todos os
Estados, exceto o de Sergipe, e a maioria absoluta dos senadores e
deputados. O \versal{PMDB} foi majoritário na Constituinte. Sendo José Sarney o
presidente da República em 1987 e também presidente do partido e com o
\versal{PMDB} no comando da Câmara dos Deputados, do Senado e ocupando a
...
Cabral (\versal{PMDB}"-\versal{AM}). Foi produzida no final de 1987 a primeira versão do
...
Constituinte resolveram se rebelar contra a liderança do \versal{PMDB} e
...
O poder de fogo do governo Sarney, as fichas que
...
\noindent\emph{Durante a \versal{ANC} houve um momento tenso. Terminados os trabalhos da
...
reitor Cristovam Buarque, organizamos o \versal{CEAC} (Centro de Estudos e
...
O \versal{CEAC} reuniu alunos, professores e funcionários da \versal{U}n\versal{B}. Contou também
...
mostrei que o maior partido da Constituinte não era o \versal{PMDB}, mas a Arena.
Pesquisei as origens de muitos deputados e muitos deles passaram pela a
Arena, \versal{PDS} e, depois, entraram no \versal{PMDB} por conveniência, para se
elegerem em 1986.

Os progressistas conseguiram eleger o Mário Covas como líder do \versal{PMDB} na
...
discurso muito contundente, reverteu a bancada do \versal{PMDB} em favor de sua
eleição.

Ao longo da Constituinte se organizou um grupo que era chamado \versal{MUP}
...
na Constituinte. Uma boa parte desse \versal{MUP}, em junho de 1988, se
transformou no \versal{PSDB}, como uma reação contra o \versal{PMDB} no Centrão.

\medskip

\noindent\emph{Havia vários grupos: \versal{MUP}, centrinho e outros. Como eles se
...
utilizar a nova cota de deputados nas eleições de 1990, o \versal{TSE} (Tribunal
...
então presidente Fernando Henrique Cardoso (\versal{PSDB}"-\versal{SP}), para permitir um
...
\chapter{José Genoíno\footnote{Cearense de Quixeramobim, iniciou sua militância na União Nacional dos
Estudantes (\versal{UNE}). Ingressa no Partido Comunista do Brasil (\versal{PC}do\versal{B}),
...
Fundador do \versal{PT} (1981), partido pelo qual foi deputado federal (1982-2002
e 2006-2013).}}
\hedramarkboth{Entrevista -- José Genoíno}{}

\emph{\versal{CLEONILDO CRUZ}: Antes da Constituinte o senhor já era deputado. O foi de 1983 a
1987 e foi eleito também deputado constituinte. Na época o senhor era
membro do Diretório Nacional do \versal{PT}. O senhor fez parte da Comissão de
Sistematização?}

\versal{JOSÉ GENOÍNO}: Fiz parte da Comissão de Sistematização e fui vice"-líder
da bancada do \versal{PT} com o outro vice"-líder, Plínio
Arruda Sampaio (\versal{PT}"-\versal{SP}),
e com o líder e companheiro Lula (\versal{PT}"-\versal{SP}). Integrei a Subcomissão de
...
Atuei com a deputada Cristina Tavares (\versal{PMDB}"-\versal{PE}) na Comissão de
...
que era uma Comissão do Congresso de deputados e senadores. Mesmo o \versal{PT}
...
1986, pelo \versal{PMDB}"-\versal{SP}), que previu uma Constituinte Exclusiva tendo apoio
do \versal{PT}, foi derrotado; aprovou"-se outro relatório, que foi
do Congresso Constituinte do Jovani Masini (\versal{PMDB}"-\versal{PR}). E participei,
...
o Congresso Constituinte. Portanto o \versal{PT} defendeu uma Constituinte
Exclusiva.
...
participação da oposição no Colégio Eleitoral -- como é sabido, o \versal{PT} não
...
\noindent\emph{Esse foi o primeiro embate político dos partidos de esquerda \versal{PCB},
\versal{PT}, \versal{PC}do\versal{B} e o \versal{PSB}. Foi nesse processo de embate que demonstrou"-se uma
coesão do processo decisório para formação do bloco de esquerda?}

Nós formamos um bloco de esquerda que eles chamavam,
no \versal{PMDB}, a ``tendência popular'': o
\versal{PT}, o \versal{PC}do\versal{B}, o \versal{PSB}. E esse bloco fez
uma articulação com o \versal{PMDB} liderado por
Mário Covas (\versal{PMDB}"-\versal{SP}), Fernando
Henrique Cardoso (\versal{PMDB}"-\versal{SP}), Pimenta
da Veiga (\versal{PMDB}"-\versal{MG}), Nelson Jobim
(\versal{PMDB}"-\versal{RS}). E nós fizemos maioria na Comissão de Sistematização. A
...
representado pelo \versal{PMDB}, e foi o que possibilitou aprovarmos muitas
...
regimentais que o senhor comentou. Houve um acordo entre o líder do \versal{PFL},
José Lourenço (\versal{PFL}"-\versal{BA}), e Mário
Covas (\versal{PMDB}"-\versal{SP}) na questão das
relatorias, para que a maioria das relatorias ficassem com o bloco
progressista do \versal{PMDB}. A Presidência coube ao bloco mais conservador:
\versal{PFL}, partidos da obra. E os partidos de esquerda eram uma frente
pequena. O poder de agenda e decisão esteve nas mãos dos relatores, nas
mãos do \versal{PMDB}. O papel dos partidos de esquerda foi irrelevante nesse
aspecto?}

Vivíamos um processo democrático em construção. A
...
entidades, das aliança com a Igreja, com a \versal{CUT} (Central Única dos
...
sala. Precisávamos de uma aliança política com o \versal{PMDB}. E essa aliança
...
garantimos as conquistas. Na aliança com o \versal{PMDB}, toda a estratégia de
...
Cabral (\versal{PMDB}"-\versal{AM}) adotasse essa formulação do pré"-projeto que foi para a
...
Acho que esse tema é importante como outros que vamos
...
de Fernando Henrique Cardoso (\versal{PSDB}"-\versal{SP}), mas não foi consolidado. E agora
...
anos. E 20 anos depois o governo Lula (\versal{PT}"-\versal{SP}) manda para o Congresso
...
de tudo: da \versal{UDR} ao \versal{MST}, das mulheres à igreja, do movimento gay às
...
Diretas, derrota do Plano Cruzado, morte do Tancredo (\versal{PMDB}). Três
...
da \versal{UDR} e os do Poder Judiciário. Mesmos os militares, que pressionaram,
possuíam um lobby menor que o do Poder Judiciário e o da \versal{UDR}.
...
Os principais impasses foram no sentido de construir
...
pelo líder do \versal{PMDB}; o resultado não é compatível com a composição
...
colocar o Estatuto da Terra na Constituinte e perdemos para \versal{UDR}. Vários
itens.
...
janeiro de 1988 a \versal{CNBB} critica o quadro socioeconômico e a operação
...
Eu não reduzo o enfrentamento político a uma política
...
status quo. O \versal{PT} se posicionou pelo presidencialismo porque estávamos
...
\chapter{Cristovam Buarque\footnote{Engenheiro pela \versal{UFPE}, inicia a militância no movimento estudantil Ação
...
ao Brasil, foi reitor da Universidade de Brasília (1985-1989). Pelo \versal{PT},
...
da Educação (2003-2004). Migrou para o \versal{PDT} em 2004, partido pelo qual se
candidatou sem sucesso à Presidência da República (2006) e se elegeu
mais uma vez para o Senado (2010-2018).}}
\hedramarkboth{Entrevista -- Cristovam Buarque}{}

\emph{\versal{CLEONILDO CRUZ}: Senador, já na
instalação da \versal{ANC}, em 1° de Fevereiro de 1987,
...
\versal{CRISTOVAM BUARQUE}: Total. Absoluta. Grande parte das falhas que a nossa
...
República, o presidente Sarney (\versal{PMDB}), que teve a gentileza de dizer
...
fazem isso: formam médicos e quantos vão para o \versal{SUS} (Sistema Único de
...
\versal{SUS} está prestando um serviço público. A Constituição deveria ter
...
São Bernardo do Campo e Diadema em 1981. Fundou a \versal{CUT} (1983), sendo o
primeiro presidente da entidade (1983-1993). Foi deputado federal pelo
\versal{PT} (1995-2002) e presidente do Conselho Nacional do \versal{SESI} (2003-2014).}}
\hedramarkboth{Entrevista -- Jair Meneguelli}{}

\emph{\versal{CLEONILDO CRUZ}: O governo de José Sarney, primeiro presidente civil após o
...
\versal{JAIR MENEGUELLI}: Todos os planos e diga"-se planos econômicos
...
através da Central Única dos Trabalhadores -- \versal{CUT} e das outras centrais,
os trabalhadores para se fazerem presentes no processo da \versal{ANC}? Como se
deu a articulação?}

O movimento sindical trabalhou. Participamos de
abaixo"-assinados. Lembro"-me que entregamos, no salão negro da Câmara, um
grande abaixo"-assinado ao Ulysses Guimarães (\versal{PMDB}"-\versal{SP}), que presidia a
...
força de esquerda muito grande na \versal{ANC}. Discutimos, apresentamos
...
cabendo ao \versal{PMDB}, sob a liderança de Mário
Covas (\versal{PMDB}"-\versal{SP}), encaminhar as
propostas progressistas. Foi bastante ideológico o embate entre
progressistas e conservadores. Como foi sentar, como presidente da \versal{CUT},
com os parlamentares do \versal{PMDB}, com o \versal{PT} e os demais parlamentares para
...
Cabral (\versal{PMDB}"-\versal{AM}). Não só o Bernardo Cabral, mas como outros
...
\noindent\emph{A Emenda Popular elaborada pelo \versal{DIAP} (Departamento
...
de assinaturas. Elas ainda tinham de passsar pelo crivo da \versal{ANC} -- e não
passaram. Não sei dizer se àquela época já existia o \versal{PROCON} (Programa de
...
\noindent\emph{No âmbito da \versal{ANC}, quais disputas foram as mais ferrenhas, que
...
Passou"-se a \versal{ANC}, passaram"-se vários governos e até hoje estamos falando
...
alguns do \versal{PMDB}, para manter as conquistas de então?}
...
prevaleceria. O que sobra é posterior à \versal{ANC}: emendar e reformar a
...
defensor de que nós deixemos de lado a \versal{CLT} e apresentemos um código
nacional do trabalho, muito mais resumido, mais sintético, porque para
um trabalhador entender a \versal{CLT}, para um humano normal entender a
...
Recife.}}
\hedramarkboth{Entrevista -- Egídio Ferreira Lima}{}

\emph{\versal{CLEONILDO CRUZ}: Na semana em que foi instalada a Assembleia Nacional
...
\versal{EGÍDIO FERREIRA LIMA}: Quero destacar inicialmente que essa Constituinte não
...
Neves (\versal{PMDB}"-\versal{MG}) e pela união do \versal{MDB} em torno de Tancredo -- houve
apenas um voto discrepante, que foi a abstenção de Jarbas Vasconcelos
(\versal{PMDB}"-\versal{PE}), que foi governador. Todos os demais votaram pela a eleição de
...
Presidência da Câmara, que foram o Ulysses Guimarães (\versal{PMDB}"-\versal{SP}) e o
Fernando Lyra (\versal{PMDB}"-\versal{PE}). Fernando Lyra colocava que era muito poder nas
mão de Ulysses Guimarães, que este era presidente da Câmara, presidente
da Assembleia Nacional Constituinte, presidente do \versal{PMDB} e, ainda, na
ausência de Sarney, vice"-presidente do país. Trinta de janeiro,
véspera da abertura, houve uma reunião da bancada do \versal{PMDB} -- que possuía
...
deputado Fernando Lyra a Ulysses Guimarães e ao conjunto do \versal{PMDB}?}

Respondo a você com uma pergunta: como Ulysses não
poderia ou deveria ser deixado de lado na disputa pela Presidência da
Constituinte? Ulysses organizou o \versal{MDB} no seu começo, constituído, criado
...
Moreira Alves (\versal{STF}), o deputado Plínio Arruda Sampaio (\versal{PT}"-\versal{SP}) levantou a
...
Roberto Freire (\versal{PCB}"-\versal{PE}) também se insurgiu e colocou. Mas no processo de
votação as lideranças partidárias do \versal{PMDB}, do \versal{PFL}, do \versal{PDS}, do \versal{PTB}, do
\versal{PL}, do \versal{PDC} e do \versal{PDT} votaram pela participação dos senadores de 1982. O
...
\versal{PMDB}: Affonso Arinos (\versal{PFL}"-\versal{RJ}), Ulysses Guimarães (\versal{PMDB}"-\versal{SP})\ldots{} Eu fui um vice"-líder com atuação constante mesmo quando o líder estava presente.

\medskip

\noindent\emph{O \versal{PMDB} possuía 306 deputados. Se o \versal{PMDB} quisesse fazer uma
Constituição, ele a faria. O \versal{PFL} possuía 132, o \versal{PDS} 38, o \versal{PDT} 26 e os
outros partidos com menos. O \versal{PMDB} possuía a maior bancada na Assembleia
...
\versal{PT} e o \versal{PC}do\versal{B} apresentavam mais coesão e disciplina partidária nas horas
das votações. E o \versal{PMDB}, como se comportava?}

O \versal{PMDB} teve uma postura social e democrática em termos
...
classe média e pobres. Essa foi a linha do \versal{PMDB}. Durante a Constituinte
...
maior foi o Robertão (Roberto Cardoso Alves, do \versal{PMDB}"-\versal{SP}).

\medskip

\noindent\emph{Voltando ao \versal{PMDB}, fale um pouco sobre as tendências do partido.}
...
avançada. O \versal{PT} possuía uma posição voltada para o pensamento sindical,
...
ficaram no Partido Progressista, presidido pelo Roberto Freire (\versal{PCB}"-\versal{PE}).
...
(\versal{PFL}"-\versal{PE}) e todo o grupo da Arena, que se juntou à votação de Tancredo.
...
que queriam a democracia, lutavam por ela e que se uniram ao \versal{PMDB},
...
(\versal{PMDB}"-\versal{AM}), e o primeiro anteprojeto foi submetido à Comissão de
...
subcomissão teve três questões básicas: o bloco conservador -- \versal{PFL}, \versal{PDS},
\versal{PL} --, que estava defendendo as suas ideias e seus princípios no
...
(\versal{PMDB}"-\versal{SP}), Robertão, Affonso Arinos (\versal{PFL}"-\versal{RJ}), as lideranças todas. Era
...
funcionamento do Senado e da Câmara. O deputado José Lourenço (\versal{PFL}"-\versal{BA})
...
nela, entrando nela como fez a Arena ao se transformar em \versal{PDS}? E ainda
...
(\versal{PFL}"-\versal{BA}), que disse: ``Egídio quer se tornar um novo Rui Barbosa e
escrever a Constituição Brasileira sozinho?''}

(Risos) O problema dos cinco anos é que não fazia
...
\hedramarkboth{Entrevista -- Marcos Terena}{}

\emph{\versal{CLEONILDO CRUZ}: Nos reportemos a 1987 e 1988. O que foi o período
...
\versal{MARCOS TERENA}: Como estávamos em processo de organizar os movimentos
...
para se fazer representar. Tivemos representantes em partidos como o \versal{PT},
o \versal{PDT}, o \versal{PC}do\versal{B} e tivemos indígenas também do \versal{PFL}. E pedimos audiência
com o presidente da Assembleia Nacional Constituinte, que foi um aliado
forte nosso, o Ulysses Guimarães (\versal{PMDB}"-\versal{SP}).
...
Benedita da Silva (\versal{PT}"-\versal{RJ}); o apoio dos movimentos de trabalhadores, como
a Central Única de Trabalhadores -- \versal{CUT}; o apoio dos professores, que
...
estavam no \versal{PFL}, outros no \versal{PT} e porque outros estavam se articulando
...
indígenas. Mário Covas (\versal{PMDB}"-\versal{SP}) foi uma liderança que conseguiu, junto
...
(\versal{PFL}"-\versal{RJ}), ligada à Igreja Católica e professora. Ela tinha uma forma de
...
mas também pelos setores da Igreja Católica, a \versal{CNBB}, da Comissão
...
Na última etapa dessa articulação -- como falei, houve
...
\versal{CUT} (1983-1986). Filia"-se ao \versal{PT} em 1985, sendo eleito logo em seguida
deputado federal (1987-2003), quando se elege senador (2003-2018).}}
\hedramarkboth{Entrevista -- Paulo Paim}{}

\emph{\versal{CLEONILDO CRUZ}: Na Assembleia Nacional Constituinte o senhor fez parte da
...
\versal{PAULO PAIM}: Eu tive duas indicações, mas depois o \versal{PT} me deixou
...
Com certeza. Na época se pensou numa grande minuta e que,
...
nosso eixo foi uma proposta apresentada pelo \versal{DIAP} e assinada por todas
as confederações, elencando o que nós, do Movimento Sindical,
entendíamos que seria adequado para a Ordem Social.

\medskip

\noindent\emph{Sendo as maiores bancadas na \versal{ANC} as do \versal{PMDB} e do \versal{PFL}, os
...
Fizemos uma parceria entre, principalmente, \versal{PMDB},
\versal{PDT}, \versal{PSB}, \versal{PTB}, \versal{PC}do\versal{B} e
o \versal{PT}, naturalmente. Esses setores tinham uma parceria com uma área muito
expressiva dentro do \versal{PMDB}. O Mário Covas (\versal{PMDB}"-\versal{SP}) na época era nosso
aliado direto, o Bernardo Cabral (\versal{PMDB}"-\versal{AM}), o Ulysses Guimarães
(\versal{PMDB}"-\versal{SP}). E não eram dos chamados ``partidos de esquerda''.
...
O João Paulo de Moura Vades (\versal{PT}"-\versal{MG}) e eu fomos ao interior de Minas,
numa fazenda. Lá articulamos a negociação. Fomos e voltamos num
``teco"-teco'' e, aqui, sentamos numa mesa com o Lula(\versal{PT}"-\versal{SP}), Olívio
Dutra (\versal{PT}"-\versal{RS}), João Paulo,
Covas(\versal{PMDB}"-\versal{SP}) e chegamos ao entendimento de
...
Passarinho (\versal{PDS}"-\versal{PA}) e ele disse: ``está bem, Paim, com essa redação eu
...
\noindent\emph{No inicio dos trabalhos o deputado Fernando Lyra (\versal{PMDB}"-\versal{PE}), que
...
presidente do Congresso, da Assembleia Nacional Constituinte, do \versal{PMDB} e,
na ausência do Sarney, vice"-presidente do país. Como eram vistas essas
críticas a Ulysses Guimarães? Eram justas?}

Na época nós entendíamos que essas críticas tinham
...
o \versal{PMDB}, a Constituinte\ldots{} Mas ele cumpriu um papel histórico. Se eu
...
até hoje para aprovar a Convenção da \versal{OIT} que recomenda que todos os
...
convenção da \versal{OIT} proibindo a demissão imotivada.

\medskip

\noindent\emph{Sobre a questão da reforma agrária houve muitos confrontos entre
os trabalhadores rurais e os representantes da \versal{UDR}. Como foi a sua
...
plenário. O Juarez Antunes (\versal{PDT}"-\versal{RJ}), um líder sindical, levou um soco no
...
\noindent\emph{Por que o \versal{PT} não assinou a Carta?}

Essa é uma boa pergunta, que me permite esclarecer ao
Brasil que isso não é verdade, mas uma mentira que a grande imprensa
vendeu para sociedade brasileira. O \versal{PT} assinou a Carta. Basta ler a
...
interno no \versal{PT} se assinaríamos ou não. Prevaleceu por ampla maioria que
deveríamos assinar. Eu tenho minha foto assinando a Constituição com meu
filho ao lado. O que aconteceu é que o \versal{PT} queria mais avanços na Carta
...
verdadeiro, que o \versal{PT} votou contra na Assembleia Nacional Constituinte.
Mas votar e submeter é uma coisa, outra é assinar e reconhecer que o
texto foi um avanço. O \versal{PT} assinou a Constituição. É só olhar na última
página: estão lá os nome dos que assinaram.

\medskip

\noindent\emph{Todos os deputados do \versal{PT} assinaram?}
...
Minha posição é clara e é também a posição também do \versal{PT}:
...
Guerra (\versal{PFL}"-\versal{PR}), o da licença paternidade. Quando ele começou a falar,
...
Ulysses, o João Paulo, o Genoíno (\versal{PT}"-\versal{SP}), cumprimos o papel de aglutinar
...
\noindent\emph{Por que o \versal{PT} fechou na questão do presidencialismo e não do
parlamentarismo?}

No \versal{PT} não foi uma opção fechada. Eu, por exemplo, sempre
...
sindicalista. Cheguei indicado não pelo \versal{PT}, mas por um Congresso
Estadual de Trabalhadores no Rio Grande do Sul. Queríamos um trabalhador
na Constituinte e de lá saiu o meu nome. Eu me filiei ao \versal{PT} e me
...
instrumento do parlamentarismo que o Jobim (\versal{PMDB}"-\versal{RS}) trouxe do exterior
...
mundo. Eu tenho uma Emenda Constitucional do \versal{FUNDEB} (Fundo de Manutenção
...
de 1980. Presidiu o sindicato de 1987 a 1993. É fundador do \versal{PT} (1981) e
da \versal{CUT} (1983), tendo presidido a Central de 1994 a 2000. É deputado
federal pelo \versal{PT} (2003-2018).}}
\hedramarkboth{Entrevista -- Vicentinho}{}

\emph{\versal{CLEONILDO CRUZ}: A Assembleia Nacional Constituinte tem início no dia 1° de
...
\versal{VICENTINHO}: Já havia a Central Única dos Trabalhadores como a
...
assembleias, grandes passeatas, vindas a Brasília\ldots{} De maneira que
...
o \versal{DIAP} (Departamento Intersindical de Assessoria Parlamentar), que teve
um papel decisivo, inclusive dando nota sobre o comportamento dos
parlamentares nas questões do nosso interesse.

\medskip

\noindent\emph{Havia a \versal{CUT}, a \versal{CGT}, a \versal{CONTAG} e vários sindicatos. Na defesa dos
direitos dos trabalhadores havia unidade ou interesses conflitantes?}

Havia unidade nos interesses, mas havia diferenças
na prática. A Central Única dos Trabalhadores -- \versal{CUT} foi a grande
...
\noindent\emph{A campanha que a \versal{CUT} fez contra os deputados constituintes que
...
\noindent\emph{Meneguelli era o presidente da \versal{CUT} e você o presidente do
...
Não representou a vitória do movimento sindical.
...
de Emendas à Constituição, como a \versal{PEC} da reforma sindical, da qual eu
sou autor em parceria com meu colega Maurício Rands (\versal{PT}"-\versal{PE}).

\chapter{Cronologia da Assembleia Nacional Constituinte}

\forceindent{}\textbf{-1985-}
...
• 1º de fevereiro: Instalação da Assembleia Nacional Constituinte.
...
• 27 de Março: Eleição da mesa Diretora da \versal{ANC}.
...
Constituinte, com a presença de várias entidades (\versal{CEAC} da Unb, \versal{INESC},
\versal{DIAP}, \versal{IBASE}, \versal{CEDAC}, \versal{FASE}, etc) e de centenas de pessoas.
...
• 11 de julho: Marcha sobre o congresso, organizada pela \versal{UDR}.
