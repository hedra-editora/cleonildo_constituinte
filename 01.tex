...
\footnote{Sociólogo formado pela Universidade de São Paulo (\versal{USP}), onde também
...
\emph{\versal{ENTREVISTADORES:} Presidente Fernando Henrique Cardoso, vamos mergulhar na
...
\footnote{Advogado e professor universitário, filiou"-se à \versal{ARENA} ainda na
...
\emph{\versal{ENTREVISTADORES}: Marco Maciel, a Frente Liberal liderada pelo senhor foi criada
...
\footnote{Profissional de letras, iniciou sua carreira política no \versal{PSD} sendo
...
\emph{\versal{ENTREVISTADORES}: A Assembleia Nacional Constituinte foi instalada no dia 1º de
...
\emph{\versal{ENTREVISTADORES}: A instalação da Assembleia Nacional Constituinte aconteceu em 1º
...
\footnote{Advogado, foi deputado federal pelo \versal{PMDB} por cinco legislaturas
...
\emph{\versal{ENTREVISTADORES}: A instalação da Assembleia Nacional Constituinte se deu em que
contexto político?}
...
\footnote{O advogado iniciou sua vida pública como deputado estadual pelo \versal{MDB}
...
\emph{\versal{ENTREVISTADORES}: Em julho de 1985, em pleno processo de transição democrática, o
...
\emph{\versal{ENTREVISTADORES}: Dr. Roberto Freire, no final de 1985 travou"-se um grande debate
...
\emph{\versal{ENTREVISTADORES}: Antes da Constituinte o senhor já era deputado. O foi de 1983 a
...
\footnote{Engenheiro pela \versal{UFPE}, inicia a militância no movimento estudantil Ação
...
\emph{\versal{ENTREVISTADORES}: Senador, já na
...
\emph{\versal{ENTREVISTADORES}: O governo de José Sarney, primeiro presidente civil após o
...
\emph{\versal{ENTREVISTADORES}: Na semana em que foi instalada a Assembleia Nacional
...
\emph{\versal{ENTREVISTADORES}: Nos reportemos a 1987 e 1988. O que foi o período
...
\emph{\versal{ENTREVISTADORES}: Na Assembleia Nacional Constituinte o senhor fez parte da
...
\emph{\versal{ENTREVISTADORES}: A Assembleia Nacional Constituinte tem início no dia 1° de
