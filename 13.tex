\textbf{Réquiem para a} \textbf{Constituição 1988}

\begin{quote}
\emph{\textbf{Rafael Valim}}, Doutor e Mestre em Direito Administrativo
pela PUC/SP. Professor de Direito Administrativo da Faculdade de Direito
da PUC/SP. Advogado.
\end{quote}
...
cidadãos''.\footnote{PINHEIRO, Paulo Sergio. ``Estado e Terror''.
  \emph{In}: NOVAES, Adauto (coord.). \emph{Ética}. São Paulo: Companhia
...
escárnio universal do Judiciário brasileiro\footnote{P.A. N.
  0003021-32.2016.4.04.8000/RS -- Corte Especial. Neste caso, não se
...
XII) pode, em casos excepcionais, ser suplantado pelo interesse geral na
...
histórica no exercício da função jurisdicional.\footnote{Para um exame
  aprofundado do caso, consultar: ZANIN MARTINS, Cristiano; ZANIN
  MARTINS, Valeska Teixeira; VALIM, Rafael (coord.). \emph{O Caso Lula:}
...
LVII, da Constituição Federal -- segundo a qual ninguém será considerado
...
dos Trabalhos Sem Terra (MST), pela Polícia Civil do Estado de São
Paulo.
...
1\sout{º}, inc. II, da Constituição Federal.

A partir deste momento, assumiu, interinamente\footnote{Sobre o período
  de interinidade, consultar, por todos: SALGADO, Eneida Desirée.
...
Klein\footnote{Afirma Naomi Klein: ``(...) particularmente en países en
  ...
  lograr `enseñar' al público esta dura lección'' (KLEIN, Naomi.
...
inconfessáveis.\footnote{VALIM, Rafael; COLANTUONO, Pablo Ángel
  Gutiérrez. O enfrentamento da corrupção nos limites do Estado de
  Direito. \emph{In}: ZANIN MARTINS, Cristiano; ZANIN MARTINS, Valeska
  Teixeira; VALIM, Rafael (coord.). \emph{O Caso Lula: a luta pela
...
de políticas de desenvolvimento de longo prazo.\footnote{SOUZA, Jessé.
...
inatacável''.\footnote{SOUZA, Jessé. \emph{A radiografia do golpe}. São
...
políticos --, em um acelerado \emph{processo desconstituinte.}\footnote{FERRAJOLI,
...
estrutural\footnote{Merecem transcrição as palavras dos Professores Luiz
  ...
  a vida civilizada'' (BELLUZZO, Luiz Gonzaga; GALÍPOLO, Gabriel.
...
projeto de resistência à racionalidade neoliberal.\footnote{SANTOS,
  ...
  AVELÃS NUNES, António José. \emph{A crise atual do capitalismo:}
...
da \emph{guerra}, própria da necropolítica neoliberal\footnote{MBEMBE,
...
hence to collaboratively govern themselves''. \footnote{BROWN, Wendy.
...
projetual}\footnote{FERRAJOLI, Luigi. \emph{A democracia através dos
...
Direito.\footnote{ZAFFARONI, E. Raúl. \emph{El derecho latinoamericano
