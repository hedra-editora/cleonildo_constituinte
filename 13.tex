...
\hedramarkboth{Réquiem para a Constituição de 1988}{}
...
democrática.\footnote{\versal{O'DONNELL}, Guilherme. ``Democracia delegativa?''.
...
claríssima violação do art. 8º da Lei nº 9.296/96, cujos termos
...
respectivas''.\footnote{O art. 9º da mesma lei ainda estabelece
...
praticou, senão que o Tribunal Regional Federal da 4ª Região, sob
...
escárnio universal do Judiciário brasileiro:\footnote{\versal{P.A.} nº
  ...
  do Tribunal Regional Federal da 4ª Região que votou pela
...
que o sigilo das comunicações telefônicas (Constituição, art. 5º,
...
qual se admitiu, em claríssimo contraste com o art. 5º, inc.
...
da Corte e a Corte de si mesma (\ldots{}). Nós queremos uma Suprema Corte que
faça justiça sob a égide da Constituição, não sobre ela.'' [\versal{N}.
do \versal{E}.]}

A degradação do Poder Judiciário é tão grave que um juiz do 3º
...
1º, inc. \versal{II}, da Constituição Federal.
...
Klein\footnote{Afirma Naomi Klein: ``(\ldots{}) \emph{particularmente en países en
  ...
  ``ensinar'' ao público essa dura lição] (\versal{KLEIN}, Naomi.
...
a si mesmos colaborativamente]. \versal{BROWN}, Wendy.
