...
\versal{AGLIETTÀ}, M. \textbf{Regulación y crisis del capitalismo}. México: Siglo
\versal{XXI}, 1979.

\versal{ALIER}, J. \textbf{El ecologismo de los pobres}: conflictos ambientales y
lenguajes de valoración. Barcelona: Icaria Editorial, 2005.

\versal{ALTVATER}, E. \textbf{O preço da riqueza}. Pilhagem ambiental e a nova
(des)ordem mundial. São Paulo: Ed. \versal{UNESP}, 1995.

\versal{ANDERSON}, C. \textbf{Makers:} a nova revolução industrial. Coimbra:
Actual, 2013.

\versal{ARON}, R. \textbf{Dezoito lições sobre a sociedade industrial}. Brasília:
\versal{UNB}/\versal{MF}, 1981.

\versal{BECK}, U. \textbf{Un nuevo mundo feliz}: la precariedad del trabajo em la
era de la globalización. Buenos Aires: Paidós, 2000.

\versal{BEINSTEIN}, J. \textbf{Capitalismo senil}. Rio de Janeiro: Record, 2001.

\versal{BELL}, D. \textbf{O advento da sociedade pós"-industrial}. São Paulo:
Cultrix, 1973.

\versal{BOLTANSKI}, L.; \versal{CHIAPELLO}, E. \textbf{O novo espírito do capitalismo.}
Rio de Janeiro: Martins Fontes, 2009.

\versal{COATES}, D. \textbf{Models of capitalism}. Oxford: Polity Press, 2000.

\versal{DAVIS}, S. \emph{et al.} \textbf{The new capitalists}. Boston: \versal{HBSP},
2008.

\versal{DREIFUSS}, R\textbf{. Transformações}: matizes do século \versal{XXI}. Petrópolis:
Vozes, 2004.

\versal{ELLSBERG}, M. \textbf{The education of milionaires}. New York: Penguin,
2011.

\versal{FREIDEN}, J. \textbf{Capitalismo global}. Madrid: M. Crítica, 2007.

\versal{GLATTFELDER}, J. \textbf{Decoding complexity}: uncovering patterns in
economic networks. Switzerland: Springer, 2013.

\versal{KUMAR}, K. \textbf{Da sociedade pós"-industrial à pós"-moderna}: novas
teorias sobre o mundo contemporâneo. 2. ed. Rio de Janeiro: Zahar, 1997.

\versal{LOJIKINE}, J. \textbf{Adieu à la classe moyenne}. Paris: La Dispute,
2005.

\versal{MARX}, K. \textbf{Grundrisse}. São Paulo: Boitempo, 2011.

\versal{MASI}, D. \textbf{O futuro do trabalho}: fadiga e ócio na sociedade
pós"-industrial. Brasília: \versal{UNB}/\versal{JOE}, 1999.

\versal{MAZOYER}, M.; \versal{ROUDART}, L. \textbf{História das agriculturas no mundo}.
São Paulo: Editora Unesp, 2009.

\versal{MELMAN}, E. \textbf{Depois do capitalismo}. São Paulo: Futura, 2002.

\versal{MILBERG}, W.; \versal{WINKLER}, D. \textbf{Outsourcing economics}: global value
chains in capitalist development. Cambridge: \versal{CUP}, 2013.

\versal{NARODOWSKI}, P.; \versal{LENICOV}, M. \textbf{Geografia económica mundial}: um
enfoque centro"-periferia. Moreno: \versal{UNM}, 2012.

\versal{O'CONNOR}, M. Is capitalism sustainable? \emph{In}: \textbf{Political
...
\textbf{Perspectives du développement mondial}. Paris: \versal{OCDE}, 2010.

\versal{POCHMANN}, M. \textbf{Classes do trabalho em mutação}. Rio de Janeiro:
Revan, 2012.

\versal{POCHMANN}, M. \textbf{O emprego na globalização}. São Paulo: Boitempo,
2001.

\versal{REICH}, R. \textbf{O futuro do sucesso}: o equilíbrio entre o trabalho e
qualidade de vida. Barueri: Manole, 2002.

\versal{ROTHKOPF}, D. \textbf{Superclass}: the global power elite and the world
they are making. London: L. B, 2008.

\versal{SANTOS}, N.; \versal{GAMA}, A. \textbf{Lazer}: da conquista do tempo à conquista
das práticas. Coimbra: \versal{IUC}, 2008.

\versal{STANDING}, G. \textbf{O precariado}: a nova classe perigosa. Belo
Horizonte: Autêntica, 2013.

\versal{REICH}, R. \textbf{Supercapitalismo}. Rio de Janeiro: Campus, 2007.
