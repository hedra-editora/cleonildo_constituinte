...
a possibilidade de incorporação lenta e gradual do trabalho rural, a \versal{CLT}
...
exemplo, a \versal{CLT} atingia mesmo de 10\% dos trabalhadores, superando
...
orientação estabelecida pela \versal{CLT}. Entre elas, a emergência da
...
da \versal{UBER}\emph{ização} do trabalho do início do século 21. Isso porque o
modo \versal{UBER} de organizar e remunerar a força de trabalho distancia"-se
